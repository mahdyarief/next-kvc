...
- **Objective**: Capture leads through a demo request form with company credibility indicators.
- **Use Case**: Landing pages, lead generation, demo requests, and sales funnels.
- **Visual Style**: Two-column layout with form, benefits list, and animated logo carousel.
- **Interactivity**: Animated infinite carousel, form inputs, and submit button.

## Description
A "Book a Demo" landing page component featuring a two-column layout. The left column displays a badge, heading, benefits list, and an infinite moving carousel of company logos. The right column contains a card with a form for users to request a demo, including fields for first name, last name, work email, job title, project description, and how they discovered the service. The component uses framer-motion for an infinite moving carousel and is fully responsive.
