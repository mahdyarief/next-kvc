...
## Metadata
- **Category**: Aceternity
- **Objective**: Animated dotted background with glow effects
- **Use Case**: Creating dynamic dotted backgrounds with pulsing glow
- **Visual Style**: Grid-based dots with organic glowing animations
- **Interactivity**: Theme-aware colors with dark/light mode support

## Description
A canvas-based dotted background component featuring organically glowing dots. Each dot has independent phase and speed, creating a natural shimmering effect. Supports theme switching between light and dark modes with customizable colors.
