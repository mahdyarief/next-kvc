...
## Metadata
- **Category**: Timeline
- **Objective**: Display a vertical timeline with historical entries about the evolution of AI.
- **Use Case**: Educational timeline showing key milestones in the history of artificial intelligence.
- **Visual Style**: Vertical timeline with circular indicators, date labels, title headings, and card-based content sections.
- **Interactivity**: Static display (no interactive elements).

## Description
A vertical timeline illustrating key milestones in the history of artificial intelligence. Features circular indicators, date labels, title headings, and card-based content sections covering events from the 1956 Dartmouth Conference to IBM's Deep Blue defeating Garry Kasparov in 1997.
