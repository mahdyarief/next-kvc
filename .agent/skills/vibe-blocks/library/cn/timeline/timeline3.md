...
## Metadata
- **Category**: Timeline
- **Objective**: Display a vertical timeline with sticky content on the left and feature cards on the right.
- **Use Case**: Product page section showcasing company milestones with sticky call-to-action on the left.
- **Visual Style**: Split layout with sticky heading/CTA on the left and feature cards with images on the right.
- **Interactivity**: Static display with clickable buttons for primary and secondary actions.

## Description
A vertical timeline with sticky content layout. Features a sticky heading, description, and call-to-action buttons on the left, paired with feature cards containing images, titles, and descriptions on the right to showcase company milestones.
