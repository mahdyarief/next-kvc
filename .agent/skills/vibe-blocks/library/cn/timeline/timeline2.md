...
## Metadata
- **Category**: Timeline
- **Objective**: Display a horizontal timeline with scroll-activated image switching.
- **Use Case**: Product page section showcasing key features with dynamic image updates as the user scrolls.
- **Visual Style**: Split layout with text sections on the left and sticky image container on the right that updates based on scroll position.
- **Interactivity**: Scroll-activated image switching, where the active section's image is displayed in the sticky container.

## Description
A horizontal timeline with scroll-activated image switching. Features split layout with text sections on the left and sticky image container on the right that dynamically updates to show the active section's image as the user scrolls through the page.
