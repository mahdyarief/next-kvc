...
- **Objective**: IDE-style layout with activity bar and panel system
- **Use Case**: Development tools and code editors
- **Visual Style**: VS Code-inspired layout with activity bar, sidebar panels, and main editor area
- **Interactivity**: Activity bar for view switching, collapsible panels, and integrated chat interface

## Description
An IDE-style application shell featuring a VS Code-inspired layout with an activity bar for switching between different views (Explorer, Search, Source Control), collapsible sidebar panels, and a main editor area with an integrated AI chat interface that can be toggled open/closed.
