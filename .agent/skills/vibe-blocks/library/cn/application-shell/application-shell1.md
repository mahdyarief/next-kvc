...
- **Objective**: Basic sidebar layout with header and breadcrumb navigation
- **Use Case**: Standard application layout with sidebar navigation and content area
- **Visual Style**: Clean sidebar with logo, navigation groups, and user footer
- **Interactivity**: Collapsible sidebar with navigation items and user dropdown

## Description
A foundational application shell featuring a sidebar with logo, navigation groups, and user profile section. Includes breadcrumb navigation in the header area for context.
