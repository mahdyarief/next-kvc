...
## Metadata
- **Category**: CTA
- **Objective**: Team-focused call to action with avatar stack and hand-drawn annotation.
- **Use Case**: Team collaboration and signup-focused promotional section with social proof.
- **Visual Style**: Centered layout with overlapping avatar stack and decorative SVG annotation.
- **Interactivity**: Single prominent action button with decorative hand-drawn arrow element.

## Description
A team-oriented call to action component featuring an overlapping avatar stack for social proof, compelling headline and description text, and a prominent action button with a hand-drawn SVG annotation arrow. Designed to emphasize team collaboration and trust-building.

## Features
- Overlapping avatar stack with 6 team member images
- Social proof through team member visualization
- Hand-drawn SVG annotation arrow pointing to CTA button
- Centered layout with professional typography
- Large prominent action button with rounded styling
- Responsive design with proper spacing
- Custom SVG line drawing for visual interest
- Caveat font for handwritten annotation text
- Professional avatar styling with borders and overlap
