...
## Metadata
- **Category**: CTA
- **Objective**: Feature showcase call to action with icon grid and prominent buttons.
- **Use Case**: Product feature highlighting with visual icons and dual action prompts.
- **Visual Style**: Two-column layout with feature icon grid and prominent CTAs.
- **Interactivity**: Icon hover effects and dual action buttons with responsive layout.

## Description
A feature-focused call to action component showcasing key product features through an icon grid, paired with compelling headline, description, and dual action buttons. Designed to highlight product capabilities while driving conversions through visual feature representation.

## Features
- Feature icon grid with 6 visual elements
