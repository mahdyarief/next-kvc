...
- **Objective**: Display customer testimonials and success metrics in a professional layout.
- **Use Case**: Customer testimonials, success stories, social proof, and credibility building.
- **Visual Style**: Two-column layout with images, quotes, customer info, and statistics.
- **Interactivity**: None (static display).

## Description
A case studies component featuring a header section with subtitle and title, followed by two main case study sections. Each case study includes an image, customer quote, customer information (name and title), company logo, and performance statistics. The component uses a two-column layout on large screens with a separator between sections, and is fully responsive.
          ...
          <div className="grid gap-16 lg:grid-cols-3 xl:gap-24">
            ...
            <div className="flex gap-10 self-center lg:flex-col">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground">Proven productivity gains</p>
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-4xl font-medium text-primary sm:text-5xl">
                  72%
