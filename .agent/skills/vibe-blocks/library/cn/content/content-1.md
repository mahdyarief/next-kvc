...
## Metadata
- **Category**: Content
- **Objective**: Article with table of contents and scroll-based navigation.
- **Use Case**: Long-form content with interactive navigation sidebar.
- **Visual Style**: Three-column layout with sticky navigation.
- **Interactivity**: Scroll-based active section highlighting.

## Description
A comprehensive article layout featuring a story about a kingdom that taxes jokes, with interactive table of contents that highlights the current section as users scroll. Includes rich content with images, tables, alerts, and structured prose.

## Features
- Scroll-based navigation with active section highlighting
- Sticky table of contents sidebar
- Responsive three-column layout
- Rich content elements (tables, alerts, blockquotes)
