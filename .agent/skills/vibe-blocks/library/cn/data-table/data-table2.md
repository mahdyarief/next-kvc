...
## Metadata
- **Category**: Data Table
- **Objective**: Advanced data table with pagination, filtering, and column visibility controls.
- **Use Case**: Complex data management with search, filtering, pagination, and column customization.
- **Visual Style**: Professional table with advanced controls and responsive pagination.
- **Interactivity**: Column sorting, global search, column visibility toggles, and pagination controls.

## Description
An advanced data table component featuring comprehensive functionality including global search, column filtering, pagination controls, and column visibility management. Built with TanStack Table for maximum performance and flexibility, suitable for complex data management scenarios.
