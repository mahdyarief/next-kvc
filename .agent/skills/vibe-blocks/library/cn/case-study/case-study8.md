...
## Metadata
- **Category**: Case Study
- **Objective**: Clean case study layout with article content and company information sidebar.
- **Use Case**: Story-driven case study with narrative content and structured company details in card format.
- **Visual Style**: Two-column layout with hero image and card-based sidebar featuring company metadata.
- **Interactivity**: Static display with responsive design.

## Description
A minimalist case study layout featuring a prominent hero image, narrative article content with prose styling, and a card-based sidebar displaying comprehensive company information including description, industry, location, size, website, and topics.
