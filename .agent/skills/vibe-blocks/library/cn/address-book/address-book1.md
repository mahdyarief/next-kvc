...
- **Objective**: Manage and select shipping addresses with full CRUD operations
- **Use Case**: E-commerce checkout, user profile address management, shipping address selection
- **Visual Style**: List-based card layout with radio button selection
- **Interactivity**: Full CRUD operations (Create, Read, Update, Delete), inline editing, radio selection, default address marking

## Description
A comprehensive address management component featuring a list-based layout with selectable address cards. Users can add, edit, and delete addresses inline, select a default address, and choose from multiple address types (home, work, other). The component includes form validation, dropdown menus for actions, and a clean card-based UI with radio button selection.

## Source Code
```tsx
"use client";

import { MapPin, MoreVertical, Pencil, Plus, Save, Trash2, X } from "lucide-react";
