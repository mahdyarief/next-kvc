...
## Metadata
- **Category**: Blog
- **Objective**: Display a customizable list of blog posts in a horizontal card layout.
- **Use Case**: Blog listings, news sections, and content hubs requiring customizable content.
- **Visual Style**: Horizontal card layout with images and metadata.
- **Interactivity**: Hover effects on images and links.

## Description
A blog component featuring a header section with a tagline badge, heading, and description, followed by a list of blog posts in a horizontal card layout. Each post includes an image, category badge, author information, publication date, title, summary, and a "Read more" link. The cards use a horizontal layout with the image on the left and content on the right (on desktop), stacking vertically on mobile. The component is fully customizable through props (tagline, heading, description, buttonText, buttonUrl, posts) and includes a "View all articles" button at the bottom.
