...
## Metadata
- **Category**: Blog
- **Objective**: Display a blog listing with author information and post metadata.
- **Use Case**: Blog archives, news sections, and content hubs with author attribution.
- **Visual Style**: Grid layout with author avatars, publication dates, and category badges.
- **Interactivity**: Static display with hover effects on post cards.

## Description
A blog listing component featuring a grid layout of blog posts with detailed metadata including author avatars, publication dates, and category badges. Each post includes an image, title, summary, author information, and publication date. The component displays a heading and subheading, and includes a responsive grid that adapts from a single column on mobile to three columns on large screens. The layout includes hover effects that adjust opacity on post images.
