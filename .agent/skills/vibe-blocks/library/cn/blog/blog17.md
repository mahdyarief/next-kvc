...
## Metadata
- **Category**: Blog
- **Objective**: Display a filterable blog post listing with category selection and author information.
- **Use Case**: Blog archives, news sections, and content hubs requiring category filtering and author attribution.
- **Visual Style**: Sidebar layout with list-based post display and category filters.
- **Interactivity**: Category filter buttons and hover effects on blog posts.

## Description
A blog listing component featuring a header section with a badge, title, and description, a left sidebar with category filter buttons, and a main content area with a list of blog posts. Each post includes category, title, description, author, and date information. The component includes interactive category filtering functionality and is fully responsive, hiding the sidebar on mobile devices.
