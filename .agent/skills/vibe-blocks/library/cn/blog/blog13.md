...
## Metadata
- **Category**: Blog
- **Objective**: Display a blog post listing with date information and category badges.
- **Use Case**: Blog archives, news sections, and content hubs requiring date stamps and category labeling.
- **Visual Style**: Grid layout with card-based post display featuring category badges and date information.
- **Interactivity**: Hover effects on blog cards and "Read more" links.

## Description
A blog listing component featuring a header section with a badge, title, description, and "View All Blogs" link, followed by a responsive grid of blog post cards. Each card includes an image with an overlaid category badge, title, and footer with publication date and "Read more" link. The layout is fully responsive, adapting from a single column on mobile to three columns on large screens.
