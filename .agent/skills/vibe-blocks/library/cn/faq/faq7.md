...
- **Objective**: Split-layout FAQ section with sidebar text and accordion
- **Use Case**: FAQ page with split layout: sidebar text and collapsible accordion
- **Visual Style**: Modern split grid layout with sidebar text and accordion on the right
- **Interactivity**: Collapsible accordion items, button links

## Description
A modern split-layout FAQ component that features a sidebar with a heading, descriptive text, and a "View all FAQs" button, plus a collapsible accordion of frequently asked questions on the right. It's perfect for a standalone FAQ page with a clear, organized layout.

## Features
- Responsive split grid layout that adapts to mobile and desktop screens
- Sidebar section with heading, descriptive text, and call-to-action button
...
- Easily customizable FAQ content, buttons, and text
