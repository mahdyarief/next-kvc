payload-base-bun\.agent\skills\vibe-blocks\library\cn\faq\faq5.md

# FAQ Component 5

## Metadata
- **Category**: FAQ Section
- **Objective**: Numbered FAQ list with badge header
- **Use Case**: Simple FAQ section with numbered list of questions and answers
- **Visual Style**: Clean, modern layout with numbered list items and badge header
- **Interactivity**: None (static numbered list of FAQ items)

## Description
A simple, clean FAQ component that displays a numbered list of frequently asked questions and answers. It features a centered badge header, section heading, and descriptive text, making it perfect for adding a minimal, organized FAQ section to any website or page.
