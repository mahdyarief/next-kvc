...
- **Objective**: Interactive categorized FAQ section with sidebar navigation and smooth scrolling
- **Use Case**: Comprehensive FAQ page with sidebar category navigation and smooth scrolling between sections
- **Visual Style**: Modern layout with sticky sidebar, categorized accordion sections, and dark/light mode support
- **Interactivity**: Collapsible accordion items, sticky sidebar category buttons, smooth scrolling between categories

## Description
An advanced interactive FAQ component that features a sticky sidebar with category navigation buttons, automatic category detection based on scroll position, and collapsible accordion items. It supports both light and dark modes, and is perfect for a detailed, professional FAQ page with multiple topic areas.

## Features
- Responsive layout that adapts to mobile and desktop screens
- Sticky sidebar with category navigation buttons
- Automatic category detection based on scroll position
- Smooth scrolling between categories with animated transitions
- Collapsible accordion items with smooth open/close animations
- Light and dark mode compatible styling
