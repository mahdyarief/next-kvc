...
- **Objective**: Modern FAQ section with badge header and support contact link
- **Use Case**: Professional FAQ page with badge header, collapsible accordion, and support contact options
- **Visual Style**: Clean, modern layout with badge header, separator, and support link at the end
- **Interactivity**: Collapsible accordion items, hover effects on triggers and support link

## Description
A modern FAQ component that features a badge header, collapsible accordion items, and a separator followed by a support contact link at the end. It's perfect for a standalone FAQ page, with a clean, organized layout that guides users from common questions to additional support options. The component follows the shadcn/ui design system for consistent styling.

## Features
- Responsive layout that adapts to mobile and desktop screens
- Badge header for the FAQ section
- Collapsible accordion items with smooth open/close animations
- Separator between the FAQ section and support link
- Support contact link with hover animation and chevron icon
- Clean, minimal styling with proper spacing and visual hierarchy
- Type-safe TypeScript interfaces
- Easily customizable FAQ questions, answers, and support link
