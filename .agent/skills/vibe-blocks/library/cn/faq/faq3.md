...
- **Objective**: Accordion-style FAQ section with header description and support contact
- **Use Case**: Professional FAQ section with introductory text and support contact options
- **Visual Style**: Clean, modern accordion layout with header text and subtle hover effects
- **Interactivity**: Collapsible accordion items, animated hover states on triggers

## Description
An enhanced accordion-style FAQ component that includes a full introductory header section with customizable heading and descriptive text, plus polished accordion items with smooth open/close animations and subtle hover effects. It follows the shadcn/ui design system for consistent, accessible styling across your site.

## Features
- Responsive layout that adapts seamlessly to mobile and desktop screens
- Introductory header block with centered text on mobile, left-aligned on desktop
- Collapsible FAQ items with smooth animations and hover state transitions
- Type-safe TypeScript interfaces for full type support
- Easily customizable FAQ questions, answers, and section copy
- Clean, minimal styling with proper spacing and visual hierarchy
