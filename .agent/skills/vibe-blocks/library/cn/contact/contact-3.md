...
## Metadata
- **Category**: Contact
- **Objective**: Contact section with department information and global offices.
- **Use Case**: Contact page with multiple department contact options and global office locations.
- **Visual Style**: Grid-based layout with icons and location cards.
- **Interactivity**: Button interactions and navigation links.

## Description
A comprehensive contact section featuring department-specific contact options (Support, Sales, Inquiries, Verification) and a global office directory with location cards.
