...
## Metadata
- **Category**: Contact
- **Objective**: Contact form with multiple contact methods displayed.
- **Use Case**: Contact page with form and contact information displayed side-by-side with badge.
- **Visual Style**: Two-column layout with badge and icons.
- **Interactivity**: Form submission with checkbox.

## Description
A professional contact section featuring a form alongside multiple contact methods (Email, Phone, Office) with icons and a prominent badge.
