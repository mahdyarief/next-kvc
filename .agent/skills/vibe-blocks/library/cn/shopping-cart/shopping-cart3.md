...
- **Objective**: Advanced shopping cart with promo codes and trust badges
- **Use Case**: E-commerce websites, online stores, premium checkout experiences
- **Visual Style**: Professional two-column layout with comprehensive order summary
- **Interactivity**: Quantity controls, promo code application/removal, item removal, trust badge display

## Description
A comprehensive shopping cart component featuring promo code functionality with apply/remove capabilities, detailed product variants (size, color, SKU), stock status badges, and trust badges (free shipping, returns, secure checkout). Includes a sophisticated order summary with subtotal, discount calculations, shipping, and tax information. The component displays individual item prices, quantity selectors, remove functionality, and automatically calculates all pricing with promo code support. Perfect for premium e-commerce sites that need full cart management capabilities with promotional features and customer trust elements.
