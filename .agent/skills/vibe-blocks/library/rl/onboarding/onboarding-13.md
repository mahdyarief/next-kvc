...
export type Onboarding13Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding13 = (props: Onboarding13Props) => {
  const { logo, footerText, image } = {
    ...Onboarding13Defaults,
    ...props,
  };
...
export const Onboarding13Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding13.displayName = 'Onboarding13';
```
