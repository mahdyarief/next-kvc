...
export type Onboarding14Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding14 = (props: Onboarding14Props) => {
  const { logo, footerText, image } = {
    ...Onboarding14Defaults,
    ...props,
  };
...
export const Onboarding14Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding14.displayName = 'Onboarding14';
```
