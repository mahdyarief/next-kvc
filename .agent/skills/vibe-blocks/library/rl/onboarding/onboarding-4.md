...
export type Onboarding4Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding4 = (props: Onboarding4Props) => {
...
export const Onboarding4Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding4.displayName = 'Onboarding4';
```
