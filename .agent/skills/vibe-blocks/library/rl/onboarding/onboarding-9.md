...
export type Onboarding9Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding9 = (props: Onboarding9Props) => {
...
export const Onboarding9Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding9.displayName = 'Onboarding9';
```
