...
## Metadata
- **Category**: Onboarding
- **Objective**: Step-Based User Setup
- **Use Case**: App account initialization.
- **Visual Style**: Clean centered progress flow.
- **Interactivity**: Step transitions / Zod / React Hook Form.
...
export type Onboarding1Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding1 = (props: Onboarding1Props) => {
...
const StepOne: React.FC<StepProps> = ({ form }) => (
  <React.Fragment>
    <div className="mb-6 text-center md:mb-8">
      <h2 className="text-2xl font-bold md:text-4xl">Let’s start with your name & email</h2>
...
const StepTwo: React.FC<StepProps> = ({ form }) => {
  ...
  return (
    <React.Fragment>
      <div className="mb-6 text-center md:mb-8">
        <h2 className="text-2xl font-bold md:text-4xl">Let's confirm your company info</h2>
        <p className="mt-3 md:mt-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.
        </p>
      </div>
...
const StepFour: React.FC<StepProps> = ({ form }) => {
  return (
    <React.Fragment>
      <div className="mb-6 text-center md:mb-8">
        <h2 className="text-2xl font-bold md:text-4xl">Finally, how did you hear about us?</h2>
        <p className="mt-3 md:mt-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.
        </p>
      </div>
...
export const Onboarding1Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding1.displayName = 'Onboarding1';
```
