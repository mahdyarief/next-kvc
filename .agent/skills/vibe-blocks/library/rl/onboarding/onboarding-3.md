...
## Metadata
- **Category**: Onboarding
- **Objective**: Choice-Driven Setup
- **Use Case**: App personalization.
- **Visual Style**: Large interactive tiles.
- **Interactivity**: Selection driven steps.
...
export const Onboarding3 = (props: Onboarding3Props) => {
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <section className="flex grow flex-col justify-center px-[5%] pb-5 pt-11">
...
Onboarding3.displayName = 'Onboarding3';
```
