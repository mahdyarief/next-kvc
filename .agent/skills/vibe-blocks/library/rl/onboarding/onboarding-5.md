...
export type Onboarding5Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding5 = (props: Onboarding5Props) => {
...
const ProgressBar = ({ step, totalSteps }: { step: number; totalSteps: number }) => {
  return (
    <div className="mb-8 flex flex-wrap items-start justify-center gap-x-8 gap-y-12">
...
export const Onboarding5Defaults: Props = {
  logo: {
    url: "#",
