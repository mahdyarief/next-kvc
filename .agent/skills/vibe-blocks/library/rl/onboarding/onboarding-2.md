...
## Metadata
- **Category**: Onboarding
- **Objective**: Visual Welcome Flow
- **Use Case**: Customer orientation.
- **Visual Style**: Split Layout (Media + Form).
- **Interactivity**: Step navigation.
...
export type Onboarding2Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding2 = (props: Onboarding2Props) => {
...
export const Onboarding2Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding2.displayName = 'Onboarding2';
```
