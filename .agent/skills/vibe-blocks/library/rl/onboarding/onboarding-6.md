...
export type Onboarding6Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding6 = (props: Onboarding6Props) => {
...
const ProgressBar = ({ step, totalSteps }: { step: number; totalSteps: number }) => {
  return (
    <div className="mb-8 flex flex-wrap items-start justify-center gap-x-8 gap-y-4">
...
export const Onboarding6Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding6.displayName = 'Onboarding6';
```
