    ...
    <section className="py-16 md:py-24 lg:py-28">
      <div className="container">
        <Dialog>
          ...
          <DialogContent
 className="mx-auto h-dvh max-h-screen w-full max-w-lg overflow-auto bg-background-primary px-[5%] pb-28 pt-12 md:h-auto md:max-h-[80vh] md:p-12"
...
Onboarding17.displayName = 'Onboarding17';
```
