...
export type Onboarding7Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding7 = (props: Onboarding7Props) => {
...
export const Onboarding7Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding7.displayName = 'Onboarding7';
```
