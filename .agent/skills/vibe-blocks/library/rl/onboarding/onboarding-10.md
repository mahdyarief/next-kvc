...
import { BiCheck, Mail, BiSolidStar } from 'lucide-react';
import { z } from 'zod';
...
export type Onboarding10Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding10 = (props: Onboarding10Props) => {
  const { logo, footerText, testimonials } = {
    ...Onboarding10Defaults,
    ...props,
  };
...
export const Onboarding10Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding10.displayName = 'Onboarding10';
```
