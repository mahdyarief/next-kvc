...
export type Onboarding12Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Onboarding12 = (props: Onboarding12Props) => {
  const { logo, footerText, image } = {
    ...Onboarding12Defaults,
    ...props,
  };
...
export const Onboarding12Defaults: Props = {
  logo: {
    url: "#",
...
Onboarding12.displayName = 'Onboarding12';
```
