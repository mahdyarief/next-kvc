...
export type Stats55Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats55 = (props: Stats55Props) => {
...
export const Stats55Defaults: Props = {
  tagline: "Tagline",
