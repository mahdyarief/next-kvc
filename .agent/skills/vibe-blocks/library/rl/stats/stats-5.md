...
## Metadata
- **Category**: Stats
- **Objective**: Stats with Progress Bars
- **Use Case**: Goal tracking or capacity metrics.
- **Visual Style**: Progress indicator cards.
- **Interactivity**: Animation logic support.
...
export type Stats5Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats5 = (props: Stats5Props) => {
...
export const Stats5Defaults: Props = {
  tagline: "Tagline",
