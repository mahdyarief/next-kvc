...
export type Stats43Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats43 = (props: Stats43Props) => {
...
export const Stats43Defaults: Props = {
  tagline: "Tagline",
