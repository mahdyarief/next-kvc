...
export type Stats47Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats47 = (props: Stats47Props) => {
...
export const Stats47Defaults: Props = {
  tagline: "Tagline",
