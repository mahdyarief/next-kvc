...
export type Stats60Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats60 = (props: Stats60Props) => {
...
export const Stats60Defaults: Props = {
  tagline: "Tagline",
