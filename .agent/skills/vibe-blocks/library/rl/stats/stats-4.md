...
## Metadata
- **Category**: Stats
- **Objective**: Icon-Led Stats Grid
- **Use Case**: Service availability or uptime metrics.
- **Visual Style**: Card grid with icons.
...
export const Stats4Defaults: Props = {
