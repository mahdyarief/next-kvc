...
export type Stats27Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats27 = (props: Stats27Props) => {
  const { heading, description, stats, tagline, buttons } = {
    ...Stats27Defaults,
    ...props,
  };
  return (
...
export const Stats27Defaults: Props = {
  tagline: "Tagline",
