...
export type Stats35Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats35 = (props: Stats35Props) => {
  const { tagline, heading, description, image, video, stats } = {
    ...Stats35Defaults,
    ...props,
  };
...
export const Stats35Defaults: Props = {
  tagline: "Tagline",
