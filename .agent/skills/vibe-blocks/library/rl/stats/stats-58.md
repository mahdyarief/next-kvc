...
export type Stats58Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats58 = (props: Stats58Props) => {
...
export const Stats58Defaults: Props = {
  tagline: "Tagline",
