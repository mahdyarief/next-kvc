...
export type Stats32Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats32 = (props: Stats32Props) => {
...
export const Stats32Defaults: Props = {
  tagline: "Tagline",
