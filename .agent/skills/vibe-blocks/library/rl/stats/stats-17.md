...
export type Stats17Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stats17 = (props: Stats17Props) => {
...
export const Stats17Defaults: Props = {
  tagline: "Tagline",
