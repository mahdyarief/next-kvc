...
## Metadata
- **Category**: Links
- **Objective**: Visual Resource Hub
- **Use Case**: Educational or tool directories.
- **Visual Style**: Grid of linked cards.
...
export type Links3Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Links3 = (props: Links3Props) => {
 ...
 className="mb-5 size-24 rounded-full border-4 border-border-alternative object-cover md:mb-6"
            />
...
export const Links3Defaults: Props = {
  image: {
