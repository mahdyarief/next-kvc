...
export type Links9Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Links9 = (props: Links9Props) => {
      ...
      <div className="grid grid-cols-1 gap-4">
        {category.links.map((link, index) => (
          <Button
            key={index}
 className={clsx({
              "grid grid-cols-[25%_1fr] items-center gap-0 border border-border-primary p-0":
...
export const Links9Defaults: Props = {
  author: {
    avatar: {
