...
## Metadata
- **Category**: Links
- **Objective**: Personal Brand Link Page
- **Use Case**: Social media landing pages (Linktree style).
- **Visual Style**: Centered profile + Button column.
- **Interactivity**: Link actions / Newsletter Modal.
