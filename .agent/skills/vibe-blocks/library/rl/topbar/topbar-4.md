...
export type Topbar4Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Topbar4 = (props: Topbar4Props) => {
  const { logo } = {
    ...Topbar4Defaults,
    ...props,
  };
...
>
      <div className="flex min-h-16 items-center text-md font-semibold md:min-h-18 lg:text-xl">
        {logo}
      </div>
...
export const Topbar4Defaults: Props = {
  logo: "Dashboard",
};

Topbar4.displayName = 'Topbar4';
```
