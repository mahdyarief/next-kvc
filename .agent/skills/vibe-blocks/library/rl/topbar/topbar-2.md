...
## Metadata
- **Category**: Topbar
- **Objective**: Minimal Breadcrumb Topbar
- **Use Case**: Deep nested documentation.
- **Visual Style**: Thin row with path info.
- **Interactivity**: Breadcrumb links.
...
export type Topbar2Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Topbar2 = (props: Topbar2Props) => {
  const { logo } = {
    ...Topbar2Defaults,
    ...props,
  };
 ...
 className="relative flex w-full flex-wrap items-center justify-between border-b border-border-primary bg-background-primary px-6 lg:grid lg:grid-cols-[1fr_1.5fr_1fr] lg:gap-4 lg:px-8"
>
...
export const Topbar2Defaults: Props = {
  logo: {
    url: "#",
