...
## Metadata
- **Category**: Topbar
- **Objective**: App Action Header
- **Use Case**: Dashboard or SaaS interface top-bar.
- **Visual Style**: Horizontal bar + Utility icons.
- **Interactivity**: Search / Notifications / Profile Menu.
...
export type Topbar1Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Topbar1 = (props: Topbar1Props) => {
  const { logo, navLinks } = {
    ...Topbar1Defaults,
    ...props,
  };
 ...
 className="relative flex w-full flex-wrap items-center justify-between border-b border-border-primary bg-background-primary px-6 lg:px-8"
>
      <div className="flex min-h-16 items-center md:min-h-18">
        <button
 className="-ml-2 mr-4 flex size-12 flex-col items-center justify-center lg:hidden"
...
export const Topbar1Defaults: Props = {
  logo: {
    url: "#",
