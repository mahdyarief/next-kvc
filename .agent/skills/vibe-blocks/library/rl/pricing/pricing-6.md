...
## Metadata
- **Category**: Pricing
- **Objective**: Minimal Toggle Pricing
- **Use Case**: Monthly vs Yearly plans.
- **Visual Style**: Plan switcher + Grid.
- **Interactivity**: State toggle/Switch.
...
export type Pricing6Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Pricing6 = (props: Pricing6Props) => {
...
export const Pricing6Defaults: Props = {
  tagline: "Tagline",
