...
## Metadata
- **Category**: Pricing
- **Objective**: Detailed Comparison Pricing
- **Use Case**: Feature-heavy software tiers.
- **Visual Style**: Tier cards + Full feature list.
- **Interactivity**: Scroll/Compare actions.
...
export const Pricing7Defaults: Props = {
  tagline: "Tagline",
