...
export type Pricing16Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Pricing16 = (props: Pricing16Props) => {
...
export const Pricing16Defaults: Props = {
  tagline: "Tagline",
...
Pricing16.displayName = 'Pricing16';
```
