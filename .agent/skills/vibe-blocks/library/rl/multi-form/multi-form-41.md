...
export type MultiForm41Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm41 = (props: MultiForm41Props) => {
  const { image } = {
    ...MultiForm41Defaults,
    ...props,
  };
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="grid grid-cols-1 gap-20 sm:gap-12 md:gap-20 lg:grid-cols-2">
...
export const MultiForm41Defaults: Props = {
  image: {
...
MultiForm41.displayName = 'MultiForm41';
```
