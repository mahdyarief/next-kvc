...
export type MultiForm20Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm20 = (props: MultiForm20Props) => {
  const { image } = {
    ...MultiForm20Defaults,
    ...props,
  };
...
export const MultiForm20Defaults: Props = {
  image: {
...
MultiForm20.displayName = 'MultiForm20';
```
