...
export type MultiForm7Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm7 = (props: MultiForm7Props) => {
...
export const MultiForm7Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm7.displayName = 'MultiForm7';
```
