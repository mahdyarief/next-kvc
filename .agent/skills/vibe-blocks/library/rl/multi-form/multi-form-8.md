...
export type MultiForm8Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm8 = (props: MultiForm8Props) => {
...
export const MultiForm8Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm8.displayName = 'MultiForm8';
```
