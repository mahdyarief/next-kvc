...
export type MultiForm17Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm17 = (props: MultiForm17Props) => {
  const { image } = {
    ...MultiForm17Defaults,
    ...props,
  };
...
export const MultiForm17Defaults: Props = {
  image: {
