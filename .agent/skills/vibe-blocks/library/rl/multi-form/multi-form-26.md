...
export type MultiForm26Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm26 = (props: MultiForm26Props) => {
...
export const MultiForm26Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm26.displayName = 'MultiForm26';
```
