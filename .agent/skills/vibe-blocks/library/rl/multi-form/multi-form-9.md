...
export type MultiForm9Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm9 = (props: MultiForm9Props) => {
...
export const MultiForm9Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm9.displayName = 'MultiForm9';
```
