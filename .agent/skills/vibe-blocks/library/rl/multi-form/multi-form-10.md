...
export type MultiForm10Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm10 = (props: MultiForm10Props) => {
  const { logo, image, footerText } = {
    ...MultiForm10Defaults,
    ...props,
  };
...
export const MultiForm10Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm10.displayName = 'MultiForm10';
```
