...
export type MultiForm6Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm6 = (props: MultiForm6Props) => {
...
export const MultiForm6Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm6.displayName = 'MultiForm6';
```
