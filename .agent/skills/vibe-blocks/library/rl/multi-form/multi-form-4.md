...
## Metadata
- **Category**: Multi Form
- **Objective**: Multi-Step Onboarding Modal
- **Use Case**: Fast-track user configuration.
- **Visual Style**: Modal interaction.
- **Interactivity**: Zod / Hook Form integration.
...
export type MultiForm4Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm4 = (props: MultiForm4Props) => {
...
export const MultiForm4Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm4.displayName = 'MultiForm4';
```
