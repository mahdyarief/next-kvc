...
export type MultiForm33Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm33 = (props: MultiForm33Props) => {
...
export const MultiForm33Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm33.displayName = 'MultiForm33';
```
