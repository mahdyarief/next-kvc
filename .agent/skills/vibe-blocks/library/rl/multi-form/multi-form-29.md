...
export type MultiForm29Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm29 = (props: MultiForm29Props) => {
...
export const MultiForm29Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm29.displayName = 'MultiForm29';
```
