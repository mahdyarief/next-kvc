...
export type MultiForm43Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm43 = (props: MultiForm43Props) => {
  const { image } = {
    ...MultiForm43Defaults,
    ...props,
  };
...
export const MultiForm43Defaults: Props = {
  image: {
...
MultiForm43.displayName = 'MultiForm43';
```
