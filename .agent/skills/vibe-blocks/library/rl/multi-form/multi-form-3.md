...
## Metadata
- **Category**: Multi Form
- **Objective**: Interactive Choice Flow
- **Use Case**: Product recommendation surveys.
- **Visual Style**: Card-based selections.
...
export type MultiForm3Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm3 = (props: MultiForm3Props) => {
...
export const MultiForm3Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm3.displayName = 'MultiForm3';
```
