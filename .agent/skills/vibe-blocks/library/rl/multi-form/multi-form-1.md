...
## Metadata
- **Category**: Multi Form
- **Objective**: Step-by-Step Registration
- **Use Case**: Complex user sign-up flows.
- **Visual Style**: Minimalist centered steps.
- **Interactivity**: Step navigation / Zod validation.
...
export type MultiForm1Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm1 = (props: MultiForm1Props) => {
...
MultiForm1.displayName = 'MultiForm1';
```
