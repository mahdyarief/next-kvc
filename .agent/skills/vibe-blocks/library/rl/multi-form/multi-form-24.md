...
export type MultiForm24Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm24 = (props: MultiForm24Props) => {
...
export const MultiForm24Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm24.displayName = 'MultiForm24';
```
