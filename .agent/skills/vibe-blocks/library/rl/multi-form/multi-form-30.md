...
export type MultiForm30Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm30 = (props: MultiForm30Props) => {
...
export const MultiForm30Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm30.displayName = 'MultiForm30';
```
