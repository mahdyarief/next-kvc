...
export type MultiForm42Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm42 = (props: MultiForm42Props) => {
  const { image } = {
    ...MultiForm42Defaults,
    ...props,
  };
...
export const MultiForm42Defaults: Props = {
  image: {
...
MultiForm42.displayName = 'MultiForm42';
```
