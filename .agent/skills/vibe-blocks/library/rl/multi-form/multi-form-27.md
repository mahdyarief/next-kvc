...
export type MultiForm27Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm27 = (props: MultiForm27Props) => {
...
export const MultiForm27Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm27.displayName = 'MultiForm27';
```
