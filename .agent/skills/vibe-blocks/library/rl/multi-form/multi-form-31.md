...
export type MultiForm31Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm31 = (props: MultiForm31Props) => {
...
export const MultiForm31Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm31.displayName = 'MultiForm31';
```
