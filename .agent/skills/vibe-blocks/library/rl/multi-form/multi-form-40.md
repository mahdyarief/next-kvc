...
export type MultiForm40Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm40 = (props: MultiForm40Props) => {
  const { image } = {
    ...MultiForm40Defaults,
    ...props,
  };
...
export const MultiForm40Defaults: Props = {
  image: {
...
MultiForm40.displayName = 'MultiForm40';
```
