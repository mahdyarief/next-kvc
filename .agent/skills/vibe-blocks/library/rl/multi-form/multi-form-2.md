...
## Metadata
- **Category**: Multi Form
- **Objective**: Sidebar Progress Flow
- **Use Case**: Onboarding for professional services.
- **Visual Style**: Sidebar progress + Form area.
...
export type MultiForm2Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm2 = (props: MultiForm2Props) => {
...
export const MultiForm2Defaults: Props = {
  logo: {
    url: "#",
...
MultiForm2.displayName = 'MultiForm2';
```
