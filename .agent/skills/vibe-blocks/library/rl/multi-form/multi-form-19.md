...
export type MultiForm19Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const MultiForm19 = (props: MultiForm19Props) => {
  const { image } = {
    ...MultiForm19Defaults,
    ...props,
  };
...
export const MultiForm19Defaults: Props = {
  image: {
...
MultiForm19.displayName = 'MultiForm19';
```
