...
## Metadata
- **Category**: Layout
- **Objective**: Split with Floating Image
- **Use Case**: Modern split style.
- **Visual Style**: Floating visual.
...
export const Layout41 = (props: Layout41Props) => {
  const { heading, description, tagline, buttons } = {
    ...Layout41Defaults,
    ...props,
  };
  return (
