...
## Metadata
- **Category**: Layout
- **Objective**: Text Grid with Links
- **Use Case**: Navigation grid.
- **Visual Style**: Link lists.
...
export type Layout119Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout119.displayName = 'Layout119';
```
