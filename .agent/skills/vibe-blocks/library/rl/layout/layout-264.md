...
## Metadata
- **Category**: Layout
- **Objective**: Feature Grid with Prices
- **Use Case**: Pricing grid.
- **Visual Style**: Pricing.
...
export type Layout264Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout264.displayName = 'Layout264';
```
