...
## Metadata
- **Category**: Layout
- **Objective**: BG Image List
- **Use Case**: Immersive list.
- **Visual Style**: Image BG + List.
- **Interactivity**: Read.
...
export type Layout331Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout331 = (props: Layout331Props) => {
  ...
  return (
    <section className="relative px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container relative z-10">
        <div className="mx-auto mb-12 max-w-lg gap-5 text-center md:mb-18 lg:mb-20">
...
export const Layout331Defaults: Props = {
...
Layout331.displayName = 'Layout331';
```
