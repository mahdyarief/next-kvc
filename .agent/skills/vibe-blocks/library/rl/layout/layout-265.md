...
## Metadata
- **Category**: Layout
- **Objective**: Feature Grid with Users
- **Use Case**: User grid.
...
export type Layout265Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout265 = (props: Layout265Props) => {
...
export const Layout265Defaults: Props = {
  sections: [
    {
...
Layout265.displayName = 'Layout265';
```
