...
## Metadata
- **Category**: Layout
- **Objective**: BG Image Steps
- **Use Case**: Immersive process.
- **Visual Style**: Image BG + Steps.
- **Interactivity**: Flow.
...
export type Layout339Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout339 = (props: Layout339Props) => {
...
export const Layout339Defaults: Props = {
...
Layout339.displayName = 'Layout339';
```
