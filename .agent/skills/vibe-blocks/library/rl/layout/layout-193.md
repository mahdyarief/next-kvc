...
export type Layout193Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout193 = (props: Layout193Props) => {
...
export const Layout193Defaults: Props = {
  tagline: "Tagline",
...
Layout193.displayName = 'Layout193';
```
