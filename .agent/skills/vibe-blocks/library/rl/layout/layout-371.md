...
## Metadata
- **Category**: Layout
- **Objective**: Article List (Simple)
- **Use Case**: News/Blog content.
- **Visual Style**: List view.
- **Interactivity**: Read.
...
export type Layout371Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout371.displayName = 'Layout371';
```
