...
## Metadata
- **Category**: Layout
- **Objective**: Feature Grid with Intro (Card)
- **Use Case**: Card grid.
- **Visual Style**: Intro + Cards.
- **Interactivity**: Hover.
...
export type Layout301Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout301 = (props: Layout301Props) => {
  const { sections, heading } = { ...Layout301Defaults, ...props };
  return (
...
export const Layout301Defaults: Props = {
...
Layout301.displayName = 'Layout301';
```
