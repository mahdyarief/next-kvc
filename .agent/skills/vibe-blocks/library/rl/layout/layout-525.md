...
## Metadata
- **Category**: Layout
- **Objective**: Bento Grid (Product Focus)
- **Use Case**: Shop mix.
- **Visual Style**: Bento + Products.
- **Interactivity**: Shop.
...
type CardMediumProps = BaseCardProps & {
  logo: ImageProps;
  buttons: ButtonProps[];
};
...
type Props = {
  ...
  cardMedium: CardMediumProps;
  cardsSmall: CardSmallProps[];
};

export type Layout525Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout525 = (props: Layout525Props) => {
  const { tagline, heading, description, cardBig, cardMedium, cardsSmall } = {
    ...Layout525Defaults,
    ...props,
  };
...
const CardMedium: React.FC<CardMediumProps> = ({ image, logo, heading, description, buttons }) => (
...
const cardMedium: CardMediumProps = {
  image: {
    src: "https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg",
    alt: "vibecoding placeholder image",
  },
...
export const Layout525Defaults: Props = {
  tagline: "Tagline",
...
Layout525.displayName = 'Layout525';
```
