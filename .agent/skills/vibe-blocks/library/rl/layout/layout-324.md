...
## Metadata
- **Category**: Layout
- **Objective**: BG Video Feature Grid (2-Col)
...
export type Layout324Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout324 = (props: Layout324Props) => {
  const { sections, image } = { ...Layout324Defaults, ...props };
  return (
...
export const Layout324Defaults: Props = {
  sections: [
    {
      icon: {
...
Layout324.displayName = 'Layout324';
```
