...
export type Layout283Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout283 = (props: Layout283Props) => {
...
export const Layout283Defaults: Props = {
  sections: [
    {
...
Layout283.displayName = 'Layout283';
```
