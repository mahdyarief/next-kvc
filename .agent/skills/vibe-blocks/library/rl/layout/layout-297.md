...
## Metadata
- **Category**: Layout
- **Objective**: Alternating List with Stats
- **Use Case**: Data list.
- **Visual Style**: Zig-zag stats.
- **Interactivity**: Read.
...
export type Layout297Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout297.displayName = 'Layout297';
```
