...
## Metadata
- **Category**: Layout
- **Objective**: Video BG App
- **Use Case**: Immersive preview.
...
export type Layout60Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
