...
## Metadata
- **Category**: Layout
- **Objective**: BG Color Feature Grid (2-Col)
...
export type Layout326Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout326 = (props: Layout326Props) => {
  const { sections, image } = { ...Layout326Defaults, ...props };
  return (
...
export const Layout326Defaults: Props = {
  sections: [
    {
      icon: {
...
Layout326.displayName = 'Layout326';
```
