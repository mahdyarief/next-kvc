...
## Metadata
- **Category**: Layout
- **Objective**: 3-Col Feature Block (Cards)
- **Use Case**: Card features.
- **Visual Style**: Card columns.
- **Interactivity**: Hover.
...
export type Layout272Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout272 = (props: Layout272Props) => {
...
export const Layout272Defaults: Props = {
  sections: [
    {
...
Layout272.displayName = 'Layout272';
```
