...
## Metadata
- **Category**: Layout
- **Objective**: Feature Pricing with Intro
- **Use Case**: Pricing features.
- **Visual Style**: Intro + Pricing.
- **Interactivity**: Cost.
...
export type Layout319Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout319 = (props: Layout319Props) => {
...
export const Layout319Defaults: Props = {
  sections: [
    {
...
Layout319.displayName = 'Layout319';
```
