...
## Metadata
- **Category**: Layout
- **Objective**: Logo Feature
- **Use Case**: Partner highlight.
...
export type Layout20Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout20 = (props: Layout20Props) => {
...
export const Layout20Defaults: Props = {
  tagline: "Tagline",
