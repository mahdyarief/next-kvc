...
## Metadata
- **Category**: Layout
- **Objective**: Split with Compounded Stats
- **Use Case**: Detailed metrics.
- **Visual Style**: Split + Grid stats.
...
export type Layout25Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
