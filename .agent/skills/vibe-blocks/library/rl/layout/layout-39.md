...
## Metadata
- **Category**: Layout
- **Objective**: Background Video Focus
- **Use Case**: Video highlight.
...
export type Layout39Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
