...
export type Layout443Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout443 = (props: Layout443Props) => {
...
export const Layout443Defaults: Props = {
  tagline: "Tagline",
...
Layout443.displayName = 'Layout443';
```
