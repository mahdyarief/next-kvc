...
export type Layout466Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout466 = (props: Layout466Props) => {
...
export const Layout466Defaults: Props = {
  tagline: "Tagline",
...
Layout466.displayName = 'Layout466';
```
