...
## Metadata
- **Category**: Layout
- **Objective**: Feature List (Column)
- **Use Case**: Detailed feature list.
- **Visual Style**: Single column list.
...
export type Layout12Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
