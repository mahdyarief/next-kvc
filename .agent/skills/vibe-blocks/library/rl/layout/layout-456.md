...
## Metadata
- **Category**: Layout
- **Objective**: Full Width Image Collage
- **Use Case**: Immersive visual.
...
export type Layout456Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout456 = (props: Layout456Props) => {
...
export const Layout456Defaults: Props = {
  tagline: "Tagline",
...
Layout456.displayName = 'Layout456';
```
