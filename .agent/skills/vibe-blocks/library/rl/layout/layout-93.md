...
## Metadata
- **Category**: Layout
- **Objective**: Simple Grid 4-Col
- **Use Case**: Dense features.
- **Visual Style**: 4-column grid.
...
export type Layout93Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout93 = (props: Layout93Props) => {
...
export const Layout93Defaults: Props = {
  tagline: "Tagline",
