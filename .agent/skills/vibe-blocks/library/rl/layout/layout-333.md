...
## Metadata
- **Category**: Layout
- **Objective**: BG Image Stats
- **Use Case**: Immersive data.
- **Visual Style**: Image BG + Stats.
- **Interactivity**: Data.
...
export type Layout333Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout333 = (props: Layout333Props) => {
...
export const Layout333Defaults: Props = {
  tagline: "Tagline",
...
Layout333.displayName = 'Layout333';
```
