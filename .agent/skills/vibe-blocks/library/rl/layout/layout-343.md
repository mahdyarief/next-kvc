...
export type Layout343Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout343 = (props: Layout343Props) => {
...
export const Layout343Defaults: Props = {
...
Layout343.displayName = 'Layout343';
```
