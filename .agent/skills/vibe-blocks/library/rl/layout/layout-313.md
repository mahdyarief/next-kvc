...
## Metadata
- **Category**: Layout
- **Objective**: Feature List with Intro
- **Use Case**: Sequential features.
- **Visual Style**: Intro + List.
- **Interactivity**: Flow.
...
export type Layout313Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout313 = (props: Layout313Props) => {
...
export const Layout313Defaults: Props = {
...
Layout313.displayName = 'Layout313';
```
