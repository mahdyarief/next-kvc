...
## Metadata
- **Category**: Layout
- **Objective**: Featured Article + Grid
- **Use Case**: News section.
- **Visual Style**: Hero + Grid.
- **Interactivity**: Read.
...
export type Layout377Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout377 = (props: Layout377Props) => {
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-4">
            {cardsSmall.map((card, index) => (
              <div key={index} className="flex flex-col border border-border-primary">
                <div className="flex h-full flex-col justify-between md:p-8 lg:p-6">
                  <div>
...
export const Layout377Defaults: Props = {
  tagline: "Tagline",
...
Layout377.displayName = 'Layout377';
```
