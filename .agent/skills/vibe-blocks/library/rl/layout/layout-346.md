...
## Metadata
- **Category**: Layout
- **Objective**: Gallery Lightbox
- **Use Case**: Interactive gallery.
...
export type Layout346Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout346 = (props: Layout346Props) => {
...
export const Layout346Defaults: Props = {
...
Layout346.displayName = 'Layout346';
```
