...
## Metadata
- **Category**: Layout
- **Objective**: Vertical Feature Tabs (Right)
- **Use Case**: Deep dive.
- **Visual Style**: Vertical Tabs.
...
export type Layout491Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout491 = (props: Layout491Props) => {
...
export const Layout491Defaults: Props = {
  tagline: "Tagline",
...
Layout491.displayName = 'Layout491';
```
