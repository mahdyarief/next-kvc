...
## Metadata
- **Category**: Layout
- **Objective**: Split Stats (Right)
- **Use Case**: Data feature.
...
export type Layout23Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
