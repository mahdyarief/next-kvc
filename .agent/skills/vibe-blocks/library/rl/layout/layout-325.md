...
## Metadata
- **Category**: Layout
- **Objective**: BG Video Feature Grid (4-Col)
- **Use Case**: Motion immersive.
- **Visual Style**: Video BG + Grid.
- **Interactivity**: Scan.
...
export type Layout325Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout325 = (props: Layout325Props) => {
  const { sections, video, videoType } = { ...Layout325Defaults, ...props };
  return (
...
export const Layout325Defaults: Props = {
  sections: [
    {
      icon: {
...
Layout325.displayName = 'Layout325';
```
