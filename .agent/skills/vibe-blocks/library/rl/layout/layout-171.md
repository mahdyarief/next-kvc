...
## Metadata
- **Category**: Layout
- **Objective**: Icon Feature Grid (Large)
- **Use Case**: Major benefits.
- **Visual Style**: Large icon grid.
...
export type Layout171Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout171: React.FC<Layout171Props> = (props: Layout171Props) => {
  const { sections, video, videoType } = { ...Layout171Defaults, ...props };
...
export const Layout171Defaults: Props = {
  sections: [
    {
      tagline: "Tagline",
...
Layout171.displayName = 'Layout171';
```
