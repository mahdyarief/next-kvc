...
## Metadata
- **Category**: Layout
- **Objective**: Feature Split (Boxed)
- **Use Case**: Contained feature.
- **Visual Style**: Boxed split.
- **Interactivity**: Focus.
...
export type Layout474Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout474 = (props: Layout474Props) => {
...
export const Layout474Defaults: Props = {
  tagline: "Tagline",
...
Layout474.displayName = 'Layout474';
```
