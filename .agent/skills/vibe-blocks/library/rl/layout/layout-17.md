...
## Metadata
- **Category**: Layout
- **Objective**: Accordion Feature
- **Use Case**: Expandable details.
- **Visual Style**: Accordion list.
...
export type Layout17Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout17 = (props: Layout17Props) => {
  const { tagline, heading, description, features, buttons, image, video } = {
    ...Layout17Defaults,
    ...props,
  };
...
export const Layout17Defaults: Props = {
  tagline: "Tagline",
