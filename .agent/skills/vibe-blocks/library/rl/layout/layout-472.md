...
## Metadata
- **Category**: Layout
- **Objective**: Feature Split (Wide)
- **Use Case**: Immersive feature.
- **Visual Style**: Wide split.
- **Interactivity**: View.
...
export type Layout472Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout472 = (props: Layout472Props) => {
...
export const Layout472Defaults: Props = {
  tagline: "Tagline",
...
Layout472.displayName = 'Layout472';
```
