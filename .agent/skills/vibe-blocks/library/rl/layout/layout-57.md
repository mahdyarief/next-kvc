...
export type Layout57Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout57 = (props: Layout57Props) => {
  const { heading, description, subHeadings, buttons, tagline, video, videoType } = {
    ...Layout57Defaults,
    ...props,
  };
...
export const Layout57Defaults: Props = {
  tagline: "Tagline",
