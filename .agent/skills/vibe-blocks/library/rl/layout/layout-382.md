...
export const Layout382Defaults: Props = {
  tagline: "Tagline",
  ...
  smallCard: {
    tagline: "Tagline",
    image: {
      src: "https://d22po4pjz3o32e.cloudfront.net/placeholder-image-bento-portrait.svg",
...
Layout382.displayName = 'Layout382';
```
