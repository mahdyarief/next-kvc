...
## Metadata
- **Category**: Layout
- **Objective**: Feature List (Checkmarks)
- **Use Case**: Included items.
...
export type Layout204Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout204.displayName = 'Layout204';
```
