...
export type Layout211Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout211 = (props: Layout211Props) => {
...
export const Layout211Defaults: Props = {
  tagline: "Tagline",
...
Layout211.displayName = 'Layout211';
```
