...
## Metadata
- **Category**: Layout
- **Objective**: 3-Col Feature Block (Images)
- **Use Case**: Visual features.
- **Visual Style**: Image columns.
...
export type Layout274Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout274.displayName = 'Layout274';
```
