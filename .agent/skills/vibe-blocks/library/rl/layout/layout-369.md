...
## Metadata
- **Category**: Layout
- **Objective**: Overlapping Feature Grid
- **Use Case**: Depth layout.
- **Visual Style**: Overlap grid.
- **Interactivity**: Depth.
...
export type Layout369Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout369 = (props: Layout369Props) => {
...
export const Layout369Defaults: Props = {
  tagline: "Tagline",
...
Layout369.displayName = 'Layout369';
```
