...
## Metadata
- **Category**: Layout
- **Objective**: Review Aggregate
- **Use Case**: Rating summary.
- **Visual Style**: Scorecard.
- **Interactivity**: Trust.
...
export type Layout400Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout400 = (props: Layout400Props) => {
...
export const Layout400Defaults: Props = {
  tagline: "Tagline",
...
Layout400.displayName = 'Layout400';
```
