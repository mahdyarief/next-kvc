...
## Metadata
- **Category**: Layout
- **Objective**: Feature Grid with Steps
- **Use Case**: Process grid.
- **Visual Style**: Step grid.
- **Interactivity**: Steps.
...
export type Layout263Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout263 = (props: Layout263Props) => {
...
export const Layout263Defaults: Props = {
  sections: [
    {
...
Layout263.displayName = 'Layout263';
```
