...
## Metadata
- **Category**: Layout
- **Objective**: Feature Grid Masonry with Intro
...
export type Layout312Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout312 = (props: Layout312Props) => {
...
export const Layout312Defaults: Props = {
  tagline: "Tagline",
...
Layout312.displayName = 'Layout312';
```
