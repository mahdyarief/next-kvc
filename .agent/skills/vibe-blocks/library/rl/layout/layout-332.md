...
export type Layout332Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout332 = (props: Layout332Props) => {
...
export const Layout332Defaults: Props = {
  tagline: "Tagline",
...
Layout332.displayName = 'Layout332';
```
