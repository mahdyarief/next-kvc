...
## Metadata
- **Category**: Layout
- **Objective**: Video BG Split (Left)
- **Use Case**: Immersive split features.
...
export type Layout51Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout51 = (props: Layout51Props) => {
  const { heading, description, subHeadings, tagline, buttons, video, videoType } = {
    ...Layout51Defaults,
    ...props,
  };
  return (
