...
export type Layout165Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout165 = (props: Layout165Props) => {
...
export const Layout165Defaults: Props = {
  tagline: "Tagline",
...
Layout165.displayName = 'Layout165';
```
