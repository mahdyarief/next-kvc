...
## Metadata
- **Category**: Layout
- **Objective**: Split with Audio
- **Use Case**: Podcast feature.
- **Visual Style**: Split + Player.
- **Interactivity**: Listen.
...
export const Layout229 = (props: Layout229Props) => {
  const { sections } = { ...Layout229Defaults, ...props };
  return (
...
export const Layout229Defaults: Props = {
  sections: [
    {
      image: {
...
Layout229.displayName = 'Layout229';
```
