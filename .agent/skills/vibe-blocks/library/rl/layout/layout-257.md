...
## Metadata
- **Category**: Layout
- **Objective**: Feature Grid (Large Cards)
- **Use Case**: Key features.
- **Visual Style**: Large cards.
- **Interactivity**: Focus.
...
export type Layout257Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout257 = (props: Layout257Props) => {
  const { sections, image } = { ...props, ...Layout257Defaults };
  return (
...
export const Layout257Defaults: Props = {
  sections: [
    {
      image: {
...
Layout257.displayName = 'Layout257';
```
