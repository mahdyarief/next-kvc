...
## Metadata
- **Category**: Layout
- **Objective**: Split with Device Mockup
- **Use Case**: App showcase.
- **Visual Style**: Split + Device.
- **Interactivity**: View.
...
export type Layout478Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout478.displayName = 'Layout478';
```
