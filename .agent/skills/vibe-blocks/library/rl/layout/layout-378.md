...
## Metadata
- **Category**: Layout
- **Objective**: Blog Sidebar Layout
- **Use Case**: Classic blog.
- **Visual Style**: Main + Sidebar.
- **Interactivity**: Nav.
...
export type Layout378Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout378 = (props: Layout378Props) => {
...
export const Layout378Defaults: Props = {
  tagline: "Tagline",
...
Layout378.displayName = 'Layout378';
```
