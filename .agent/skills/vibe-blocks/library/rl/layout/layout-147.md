...
export type Layout147Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout147 = (props: Layout147Props) => {
...
export const Layout147Defaults: Props = {
...
Layout147.displayName = 'Layout147';
```
