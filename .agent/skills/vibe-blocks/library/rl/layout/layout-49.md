...
## Metadata
- **Category**: Layout
- **Objective**: Split with Card
- **Use Case**: Contained split.
- **Visual Style**: Card container.
...
export type Layout49Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout49 = (props: Layout49Props) => {
  const { heading, description, subHeadings, tagline, buttons, image } = {
    ...Layout49Defaults,
    ...props,
  };
  return (
...
export const Layout49Defaults: Props = {
  tagline: "Tagline",
