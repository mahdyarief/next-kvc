...
## Metadata
- **Category**: Layout
- **Objective**: Feature Split (Image List)
- **Use Case**: Multiple product highlights.
...
export type Layout202Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout202 = (props: Layout202Props) => {
...
export const Layout202Defaults: Props = {
  tagline: "Tagline",
...
Layout202.displayName = 'Layout202';
```
