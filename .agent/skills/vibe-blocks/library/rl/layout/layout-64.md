...
## Metadata
- **Category**: Layout
- **Objective**: Pattern BG Split
- **Use Case**: Textured feature.
...
export type Layout64Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
