...
## Metadata
- **Category**: Layout
- **Objective**: Intro + 4-Col Feature Grid
- **Use Case**: Dense feature set.
...
export type Layout276Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout276 = (props: Layout276Props) => {
...
export const Layout276Defaults: Props = {
  sections: [
    {
...
Layout276.displayName = 'Layout276';
```
