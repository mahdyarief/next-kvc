...
## Metadata
- **Category**: Layout
- **Objective**: Color Block Split
- **Use Case**: High contrast feature.
- **Visual Style**: Color background.
...
export type Layout63Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout63 = (props: Layout63Props) => {
...
export const Layout63Defaults: Props = {
  tagline: "Tagline",
