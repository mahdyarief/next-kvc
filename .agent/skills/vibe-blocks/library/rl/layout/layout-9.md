...
## Metadata
- **Category**: Layout
- **Objective**: Split with Video
- **Use Case**: Video feature highlight.
- **Visual Style**: Text + Video embed.
- **Interactivity**: Video impact.
...
export type Layout9Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout9 = (props: Layout9Props) => {
...
export const Layout9Defaults: Props = {
