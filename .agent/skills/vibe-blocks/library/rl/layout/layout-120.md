...
## Metadata
- **Category**: Layout
- **Objective**: Compact Text Grid
- **Use Case**: Dense info.
- **Visual Style**: Bento style.
...
export type Layout120Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout120.displayName = 'Layout120';
```
