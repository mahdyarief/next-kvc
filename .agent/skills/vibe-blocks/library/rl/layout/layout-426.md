...
## Metadata
- **Category**: Layout
- **Objective**: Interactive Map
- **Use Case**: Locations.
- **Visual Style**: Map markers.
- **Interactivity**: Click.
...
export type Layout426Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout426 = (props: Layout426Props) => {
...
export const Layout426Defaults: Props = {
  tagline: "Tagline",
...
Layout426.displayName = 'Layout426';
```
