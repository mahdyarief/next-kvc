...
## Metadata
- **Category**: Layout
- **Objective**: Schedule List
- **Use Case**: Time compare.
- **Visual Style**: Agenda view.
- **Interactivity**: Plan.
...
export type Layout145Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout145.displayName = 'Layout145';
```
