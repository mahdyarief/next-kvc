...
export type Layout96Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout96 = (props: Layout96Props) => {
  const { heading, description, image, subHeadings, video } = {
    ...Layout96Defaults,
    ...props,
  };
  return (
...
export const Layout96Defaults: Props = {
  tagline: "Tagline",
