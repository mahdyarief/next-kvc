...
## Metadata
- **Category**: Layout
- **Objective**: Split with Offset Images
- **Use Case**: Modern visual.
- **Visual Style**: Offset.
- **Interactivity**: View.
...
export type Layout454Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout454 = (props: Layout454Props) => {
...
export const Layout454Defaults: Props = {
  tagline: "Tagline",
...
Layout454.displayName = 'Layout454';
```
