...
- **Use Case**: Data features.
- **Visual Style**: Stat grid.
...
export type Layout260Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout260 = (props: Layout260Props) => {
  const { sections, video, videoType } = { ...props, ...Layout260Defaults };
  return (
...
export const Layout260Defaults: Props = {
  sections: [
    {
      tagline: "Tagline",
...
Layout260.displayName = 'Layout260';
```
