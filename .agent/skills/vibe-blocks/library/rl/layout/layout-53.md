...
## Metadata
- **Category**: Layout
- **Objective**: Video BG Center
- **Use Case**: Immersive center section.
...
export type Layout53Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout53 = (props: Layout53Props) => {
  const { heading, description, subHeadings, buttons, tagline } = {
    ...Layout53Defaults,
    ...props,
  };
  return (
...
export const Layout53Defaults: Props = {
  tagline: "Tagline",
