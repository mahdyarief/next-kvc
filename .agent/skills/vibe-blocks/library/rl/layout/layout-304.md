...
## Metadata
- **Category**: Layout
- **Objective**: Feature Grid with Intro (Buttons)
- **Use Case**: Nav grid.
- **Visual Style**: Intro + Links.
- **Interactivity**: Nav.
...
export type Layout304Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout304 = (props: Layout304Props) => {
...
export const Layout304Defaults: Props = {
  tagline: "Tagline",
...
Layout304.displayName = 'Layout304';
```
