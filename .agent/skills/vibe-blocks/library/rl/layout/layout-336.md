...
## Metadata
- **Category**: Layout
- **Objective**: BG Video Logos
- **Use Case**: Motion trust.
- **Visual Style**: Video BG + Logos.
- **Interactivity**: Trust.
...
export type Layout336Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout336 = (props: Layout336Props) => {
...
export const Layout336Defaults: Props = {
  tagline: "Tagline",
...
Layout336.displayName = 'Layout336';
```
