...
## Metadata
- **Category**: Layout
- **Objective**: Left Text + Wide Image
...
export type Layout85Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout85 = (props: Layout85Props) => {
  const { heading, description, stats, buttons, tagline, image } = {
    ...Layout85Defaults,
    ...props,
  };
  return (
...
export const Layout85Defaults: Props = {
  tagline: "Tagline",
