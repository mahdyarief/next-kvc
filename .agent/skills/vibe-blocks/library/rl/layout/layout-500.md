...
## Metadata
- **Category**: Layout
- **Objective**: Vertical Feature Tabs (Center)
- **Use Case**: Central features.
- **Visual Style**: Center Tabs.
...
export const Layout500Defaults: Props = {
  tagline: "Tagline",
...
Layout500.displayName = 'Layout500';
```
