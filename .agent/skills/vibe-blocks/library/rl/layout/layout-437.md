...
## Metadata
- **Category**: Layout
- **Objective**: Slider Full Width
- **Use Case**: Immersive gallery.
- **Visual Style**: Full carousel.
- **Interactivity**: Slide.
...
export type Layout437Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout437 = (props: Layout437Props) => {
...
export const Layout437Defaults: Props = {
  tagline: "Tagline",
...
Layout437.displayName = 'Layout437';
```
