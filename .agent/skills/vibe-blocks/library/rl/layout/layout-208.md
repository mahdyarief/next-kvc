...
## Metadata
- **Category**: Layout
- **Objective**: Feature Split (Tabs)
- **Use Case**: Categorized benefits.
- **Visual Style**: Tabbed split.
...
export type Layout208Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Layout208.displayName = 'Layout208';
```
