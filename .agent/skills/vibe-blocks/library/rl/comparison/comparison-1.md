...
## Metadata
- **Category**: Comparison
- **Objective**: Product Feature Comparison Table
- **Use Case**: Side-by-side product comparison with feature checkmarks and values.
- **Visual Style**: Multi-column table with product headers and feature rows.
- **Interactivity**: Feature row highlighting, product column emphasis.
...
Comparison1.displayName = 'Comparison1';
```
