...
## Metadata
- **Category**: Comparison
- **Objective**: Filter-Enhanced Comparison
- **Use Case**: Comparison with feature category filtering.
- **Visual Style**: Comparison table with filter controls.
- **Interactivity**: Feature category filtering, dynamic row display.
...
export type Comparison12Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Comparison12 = (props: Comparison12Props) => {
  const { tagline, heading, description, buttons, comparisonProducts, features } = {
    ...Comparison12Defaults,
    ...props,
  };
  return (
...
export const Comparison12Defaults: Props = {
  tagline: "Tagline",
      ...
      products: [
        {
          image: {
            ...
            alt: "vibecoding image 1",
          },
        },
        {
          image: {
            src: "https://d22po4pjz3o32e.cloudfront.net/vibecoding-logo.svg",
            alt: "vibecoding image 2",
          },
        },
        {
          image: {
            src: "https://d22po4pjz3o32e.cloudfront.net/vibecoding-logo.svg",
            alt: "vibecoding image 3",
          },
        },
      ],
    },
...
Comparison12.displayName = 'Comparison12';
```
