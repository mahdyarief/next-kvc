...
## Metadata
- **Category**: Grid List
- **Objective**: E-commerce Product Grid
- **Use Case**: Storefront or inventory browsing.
- **Visual Style**: Visual Pricing Cards.
- **Interactivity**: Add to Cart / Filter.
...
export const GridList6Defaults: Props = {
