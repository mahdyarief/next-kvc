...
export type Career20Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Career20 = (props: Career20Props) => {
    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        <Tabs defaultValue={defaultValue} className="flex flex-col justify-start">
          <TabsList className="no-scrollbar mb-12 ml-[-5vw] flex w-screen items-center overflow-auto pl-[5vw] md:ml-0 md:w-full md:pl-0 lg:flex-wrap">
            {tabs.map((tab, index) => (
              <TabsTrigger
                key={index}
                value={tab.value}
