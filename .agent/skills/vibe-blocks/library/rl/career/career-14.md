...
export type Career14Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Career14 = (props: Career14Props) => {
...
export const Career14Defaults: Props = {
  tagline: "Tagline",
