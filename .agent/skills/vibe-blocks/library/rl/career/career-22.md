...
export type Career22Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Career22 = (props: Career22Props) => {
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        <div className="grid items-start md:grid-cols-2 md:gap-x-12 md:gap-y-16 lg:gap-x-[3.9rem] lg:gap-y-0">
...
export const Career22Defaults: Props = {
  tagline: "Tagline",
