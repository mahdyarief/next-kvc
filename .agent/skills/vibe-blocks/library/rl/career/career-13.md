...
export type Career13Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Career13 = (props: Career13Props) => {
...
export const Career13Defaults: Props = {
  tagline: "Tagline",
