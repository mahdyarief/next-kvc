...
## Metadata
- **Category**: Career
- **Objective**: Visual Career Showcase
- **Use Case**: Culture oriented hiring.
- **Visual Style**: Featured job + visual assets.
...
export const Career3 = (props: Career3Props) => {
