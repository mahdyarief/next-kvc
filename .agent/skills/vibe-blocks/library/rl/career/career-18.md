...
export type Career18Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Career18 = (props: Career18Props) => {
...
export const Career18Defaults: Props = {
  tagline: "Tagline",
