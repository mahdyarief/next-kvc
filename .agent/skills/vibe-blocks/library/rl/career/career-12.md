...
export type Career12Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Career12 = (props: Career12Props) => {
...
export const Career12Defaults: Props = {
  tagline: "Tagline",
