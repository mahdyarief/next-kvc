...
## Metadata
- **Category**: Event
- **Objective**: Compact Calendar List
- **Use Case**: Agenda summary.
- **Visual Style**: List + Date indicators.
...
export type Event24Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
