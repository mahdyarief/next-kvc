...
## Metadata
- **Category**: Event
- **Objective**: Interactive Event Map
- **Use Case**: Location-based events.
- **Visual Style**: Map + List.
- **Interactivity**: Map markers.
...
export type Event9Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Event9 = (props: Event9Props) => {
...
export const Event9Defaults: Props = {
  tagline: "Tagline",
  heading: "Events",
