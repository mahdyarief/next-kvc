...
## Metadata
- **Category**: Event
- **Objective**: Bento Event Layout
- **Use Case**: Premium event highlight.
- **Visual Style**: Bento grid.
- **Interactivity**: Card depth.
...
export type Event30Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Event30 = (props: Event30Props) => {
    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        <div className="mt-12 flex justify-end md:hidden">
          <Button {...button} className="flex items-center justify-center gap-x-2 text-base">
            {button.title}
          </Button>
        </div>
      </div>
...
export const Event30Defaults: Props = {
  tagline: "Tagline",
  heading: "Webinars",
