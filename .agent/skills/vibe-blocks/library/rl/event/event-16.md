...
## Metadata
- **Category**: Event
- **Objective**: Split Slider Events
- **Use Case**: Feature + List carousel.
- **Visual Style**: Asymmetric slider.
...
export type Event16Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
