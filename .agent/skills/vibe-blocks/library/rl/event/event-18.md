...
## Metadata
- **Category**: Event
- **Objective**: Overlay Event Slider
- **Use Case**: High contrast browsing.
- **Visual Style**: Text overlay slider.
...
export type Event18Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Event18 = (props: Event18Props) => {
...
export const Event18Defaults: Props = {
  tagline: "Tagline",
  heading: "Events",
