...
## Metadata
- **Category**: Event
- **Objective**: Speaker-Led Schedule
- **Use Case**: Personalized agenda.
- **Visual Style**: Speaker cards in list.
- **Interactivity**: Speaker info links.
...
export type Event28Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Event28 = (props: Event28Props) => {
...
export const Event28Defaults: Props = {
  tagline: "Tagline",
  heading: "Webinars",
