...
## Metadata
- **Category**: Event
- **Objective**: Multi-Day Conference Tabs
- **Use Case**: Major conference agenda.
- **Visual Style**: Multi-day tabs.
...
export type Event22Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Event22 = (props: Event22Props) => {
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        <div className="grid auto-cols-fr grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16">
...
export const Event22Defaults: Props = {
  tagline: "Tagline",
  heading: "Events",
