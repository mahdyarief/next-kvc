...
## Metadata
- **Category**: Event
- **Objective**: Image Rich Event Carousel
- **Use Case**: Visual heavy events.
- **Visual Style**: Image cards carousel.
...
export type Event15Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Event15 = (props: Event15Props) => {
...
export const Event15Defaults: Props = {
  tagline: "Tagline",
  heading: "Events",
