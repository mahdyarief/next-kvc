...
- **Objective**: Event Detail with Speaker Highlight
- **Use Case**: Speaker-led conference sessions.
- **Visual Style**: Visual Split + Speaker info.
...
export type EventItemHeader5Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
      ...
      <div className="container relative z-10">
        <div className="grid auto-cols-fr grid-rows-[auto] items-center gap-x-20 gap-y-12 text-text-alternative md:min-h-0 md:grid-flow-row md:grid-cols-1 md:gap-y-16 lg:grid-cols-2">
          <div className="flex flex-col items-start">
            <Button {...backLink.button} className="py-1 text-text-alternative" asChild>
...
EventItemHeader5.displayName = 'EventItemHeader5';
```
