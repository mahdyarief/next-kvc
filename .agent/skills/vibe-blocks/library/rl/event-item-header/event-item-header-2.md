...
- **Objective**: Split Layout Event Detail
- **Use Case**: Standard event landing information.
- **Visual Style**: Split Content/Image.
...
export const EventItemHeader2Defaults: Props = {
  tagline: "Tagline",
...
EventItemHeader2.displayName = 'EventItemHeader2';
```
