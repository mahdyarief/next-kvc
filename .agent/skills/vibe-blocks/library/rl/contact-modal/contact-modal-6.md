...
- **Objective**: Quote Request Modal
- **Use Case**: Detailed modal for requesting product/service quotes.
- **Visual Style**: Extended modal with project detail fields.
- **Interactivity**: Multi-field validation, file upload, quote submission.
...
export type ContactModal6Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const ContactModal6 = (props: ContactModal6Props) => {
  const { heading, description, button } = {
    ...ContactModal6Defaults,
    ...props,
  };
...
export const ContactModal6Defaults: Props = {
  heading: "Contact us",
  description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
  button: { title: "Submit" },
};

ContactModal6.displayName = 'ContactModal6';
```
