...
- **Objective**: Multi-Step Modal Form
- **Use Case**: Wizard-style modal with multiple form steps.
- **Visual Style**: Modal with step indicators and navigation.
- **Interactivity**: Step progression, back/next navigation, progress tracking.
...
export const ContactModal4Defaults: Props = {
  heading: "Contact us",
  description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
  button: { title: "Submit" },
};

ContactModal4.displayName = 'ContactModal4';
```
