...
## Metadata
- **Component Name**: Blog12
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui, Lucide React
- **Objective**: Implement a tab-filtered blog listing with video-aspect images and "Read more" buttons
- **Use Case**: Ideal for high-density blog archive pages where content needs tab-based filtering and easy navigation
- **Responsive Behavior**: 1-column grid on mobile, 2-column on tablet/desktop; horizontal scroll for tab navigation on mobile
- **Visual Style**: Clean grid layout with video-aspect images, highlighted category tags, and "Read more" buttons with icons
- **Key Features**: Tab-based content filtering, video-aspect post images, highlighted category tags, "Read more" buttons with ChevronRight icons, responsive layout, default sample data for quick testing
...
export const Blog12Defaults: Props = {
  tagline: "Blog",
