...
- **Use Case**: Ideal for blogs needing a prominent hero section with a clear call-to-action followed by a grid of blog posts
...
- **Visual Style**: Prominent hero section with heading and button, followed by a clean grid of post cards with organized author metadata
- **Key Features**: Hero section with call-to-action button, grid layout of post cards, author metadata (name, date, read time), responsive button placement, default sample data for quick testing
