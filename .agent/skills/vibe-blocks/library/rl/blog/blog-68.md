...
- **Visual Style**: Hero section with left-aligned heading and right-aligned button, followed by a horizontal carousel of bordered post cards with highlighted category tags and "Read more" buttons
- **Key Features**: Horizontal carousel with navigation controls, hero section with call-to-action button, bordered post cards with aspect-ratio images, highlighted category tags, "Read more" buttons with ChevronRight icons, responsive layout, default sample data for quick testing
- **Interactivity**: Carousel navigation (previous/next buttons, indicators), post card click-through to full article, hero button navigation, "Read more" button navigation
