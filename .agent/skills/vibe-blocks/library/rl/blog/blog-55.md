...
- **Use Case**: Ideal for blogs needing a left-aligned hero section followed by a grid of posts with square-aspect images and side-by-side text layout
...
- **Visual Style**: Left-aligned hero section with heading, followed by a clean grid of post cards with square-aspect images and organized author metadata
- **Key Features**: Left-aligned hero section, square-aspect post images, side-by-side image and text layout, author metadata (name, date, read time), right-aligned "View all" call-to-action button, responsive layout, default sample data for quick testing
...
export type Blog55Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
