...
- **Use Case**: Ideal for blogs needing a subtle, centered hero section followed by a grid of posts with video-style aspect ratio images
...
- **Visual Style**: Minimal centered hero section with heading, followed by a clean grid of post cards with video-aspect images and organized author metadata
- **Key Features**: Minimal centered hero section, video-aspect post images, author metadata (name, date, read time), "View all" call-to-action button, responsive layout, default sample data for quick testing
