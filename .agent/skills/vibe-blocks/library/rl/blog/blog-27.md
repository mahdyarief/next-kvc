...
## Metadata
- **Component Name**: Blog27
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui, Framer Motion
- **Objective**: Implement a select-filtered blog listing with animated transitions
- **Use Case**: Ideal for blogs needing a clean, mobile-friendly category filtering experience with smooth animations
- **Responsive Behavior**: 1-column grid on all screen sizes; select dropdown for category filtering
- **Visual Style**: Clean vertical grid layout with select-based navigation, large post titles, and organized author metadata
- **Key Features**: Select-based content filtering, animated transitions with Framer Motion, video-aspect images, author metadata (name, date, read time), responsive layout, default sample data for quick testing
...
export const Blog27Defaults: Props = {
  tagline: "Blog",
