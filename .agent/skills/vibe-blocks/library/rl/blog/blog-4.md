...
## Metadata
- **Component Name**: Blog4
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui, clsx, Lucide React
- **Objective**: Implement a bordered blog listing with compact design and "Read more" buttons
- **Use Case**: Ideal for blogs needing a clean, structured layout with clear post boundaries and easy navigation to full articles
...
- **Visual Style**: Bordered post cards with featured images, highlighted category tags, and "Read more" buttons with icons
- **Key Features**: Category filtering navigation, bordered post cards, highlighted category tags, read time display, "Read more" buttons with ChevronRight icons, responsive layout, default sample data for quick testing
...
export type Blog4Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
