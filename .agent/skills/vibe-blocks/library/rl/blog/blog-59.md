...
## Metadata
- **Component Name**: Blog59
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui
- **Objective**: Implement a blog listing with hero section and bordered post grid
- **Use Case**: Ideal for blogs needing a hero section with left-aligned heading and right-aligned button followed by a grid of bordered posts with video-style aspect ratio images
...
- **Visual Style**: Hero section with left-aligned heading and right-aligned button, followed by a clean grid of bordered post cards with video-aspect images and organized author metadata
- **Key Features**: Hero section with call-to-action button, video-aspect post images, bordered post cards, author metadata (name, date, read time), responsive button placement, default sample data for quick testing
...
export type Blog59Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
