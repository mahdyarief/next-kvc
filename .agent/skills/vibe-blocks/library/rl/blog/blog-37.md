...
## Metadata
- **Component Name**: Blog37
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui
- **Objective**: Implement a blog listing with grid layout and right-aligned "View all" button
- **Use Case**: Ideal for blogs needing a clean grid layout of posts with a right-aligned call-to-action to view more content
- **Responsive Behavior**: 1-column grid on mobile, 2-column on tablet, 3-column on desktop
- **Visual Style**: Clean grid layout of post cards with organized author metadata and a right-aligned "View all" button
- **Key Features**: Grid layout of post cards, author metadata (name, date, read time), right-aligned "View all" call-to-action button, responsive layout, default sample data for quick testing
...
export type Blog37Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Blog37 = (props: Blog37Props) => {
...
export const Blog37Defaults: Props = {
  tagline: "Blog",
