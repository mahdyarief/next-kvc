...
## Metadata
- **Component Name**: Blog3
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui, clsx
- **Objective**: Implement a visual-heavy blog listing with bordered post cards and responsive grid layout
- **Use Case**: Ideal for image-centric blogs where visual content is the primary focus, with clear post boundaries
...
- **Visual Style**: Clean grid with bordered post cards, large featured images, and organized author metadata
- **Key Features**: Category filtering navigation, bordered post cards with featured images, author metadata (name, date, read time), responsive layout, default sample data for quick testing
