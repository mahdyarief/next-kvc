...
## Metadata
- **Component Name**: Blog16
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui, Lucide React
- **Objective**: Implement a tab-filtered blog listing with square-aspect images and side-by-side layout
- **Use Case**: Ideal for blogs where content is best displayed with square images and side-by-side text layout with "Read more" buttons
- **Responsive Behavior**: 1-column grid on mobile, 2-column on desktop; horizontal scroll for tab navigation on mobile
- **Visual Style**: Side-by-side image and text layout with square-aspect images, highlighted category tags, and "Read more" buttons with icons
- **Key Features**: Tab-based content filtering, square-aspect post images, highlighted category tags, "Read more" buttons with ChevronRight icons, responsive layout, default sample data for quick testing
...
export type Blog16Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
