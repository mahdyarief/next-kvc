...
## Metadata
- **Component Name**: Blog52
- **Category**: Blog
- **Technology Stack**: React, TypeScript, Tailwind CSS, shadcn/ui, Lucide React
- **Objective**: Implement a blog listing with left-aligned hero section and video-aspect post grid
- **Use Case**: Ideal for blogs needing a left-aligned hero section followed by a grid of posts with video-style aspect ratio images, "Read more" buttons, and a right-aligned "View all" button
...
- **Visual Style**: Left-aligned hero section with heading, followed by a clean grid of post cards with video-aspect images, highlighted category tags, and "Read more" buttons
- **Key Features**: Left-aligned hero section, video-aspect post images, highlighted category tags, "Read more" buttons with ChevronRight icons, right-aligned "View all" call-to-action button, responsive layout, default sample data for quick testing
...
export const Blog52Defaults: Props = {
  tagline: "Blog",
