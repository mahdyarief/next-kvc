...
- **Use Case**: Ideal for blogs where content is best displayed with square images and side-by-side text layout
- **Responsive Behavior**: 1-column grid on mobile, 2-column on desktop; horizontal scroll for tab navigation on mobile
- **Visual Style**: Side-by-side image and text layout with square-aspect images, tab-based navigation, and organized author metadata
- **Key Features**: Tab-based content filtering, square-aspect post images, author metadata (name, date, read time), responsive layout, default sample data for quick testing
...
export type Blog15Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Blog15Defaults: Props = {
  tagline: "Blog",
