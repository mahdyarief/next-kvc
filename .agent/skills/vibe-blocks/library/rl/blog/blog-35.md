...
- **Use Case**: Ideal for blogs needing clear post boundaries with bordered cards and a central "View all" call-to-action
- **Responsive Behavior**: 1-column grid on mobile, 2-column on tablet, 3-column on desktop
- **Visual Style**: Clean grid layout of bordered post cards with organized author metadata and a centered "View all" button
- **Key Features**: Bordered post cards, author metadata (name, date, read time), "View all" call-to-action button, responsive layout, default sample data for quick testing
