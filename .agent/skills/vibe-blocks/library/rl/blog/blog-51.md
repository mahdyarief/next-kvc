...
- **Use Case**: Ideal for blogs needing a left-aligned hero section followed by a grid of posts with video-style aspect ratio images and a right-aligned "View all" button
...
- **Visual Style**: Left-aligned hero section with heading, followed by a clean grid of post cards with video-aspect images and organized author metadata
- **Key Features**: Left-aligned hero section, video-aspect post images, author metadata (name, date, read time), right-aligned "View all" call-to-action button, responsive layout, default sample data for quick testing
...
export type Blog51Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
