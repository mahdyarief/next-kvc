...
- **Use Case**: Ideal for blogs needing clear post boundaries with bordered cards, individual "Read more" links, and a right-aligned "View all" call-to-action
- **Responsive Behavior**: 1-column grid on mobile, 2-column on tablet, 3-column on desktop
- **Visual Style**: Clean grid layout of bordered post cards with highlighted category tags, "Read more" buttons with icons, and a right-aligned "View all" button
- **Key Features**: Bordered post cards, highlighted category tags, "Read more" buttons with ChevronRight icons, right-aligned "View all" call-to-action button, responsive layout, default sample data for quick testing
