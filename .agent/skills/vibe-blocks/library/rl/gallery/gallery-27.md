...
## Metadata
- **Category**: Gallery
- **Objective**: Side-Peek Carousel
- **Use Case**: Dynamic interactive discovery.
- **Visual Style**: Off-center slider.
- **Interactivity**: Slide controls / Indicators.
...
export type Gallery27Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Gallery27 = (props: Gallery27Props) => {
...
Gallery27.displayName = 'Gallery27';
```
