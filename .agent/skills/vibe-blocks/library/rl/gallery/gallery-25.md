...
## Metadata
- **Category**: Gallery
- **Objective**: Split Screen Gallery
- **Use Case**: Editorial layout look.
- **Visual Style**: Half-page visual slider.
...
export type Gallery25Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Gallery25 = (props: Gallery25Props) => {
...
export const Gallery25Defaults: Props = {
...
Gallery25.displayName = 'Gallery25';
```
