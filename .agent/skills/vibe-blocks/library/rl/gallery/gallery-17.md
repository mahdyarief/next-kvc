...
## Metadata
- **Category**: Gallery
- **Objective**: Vertical Scrolling Gallery
- **Use Case**: Modern mobile browsing.
- **Visual Style**: Vertical visual list.
- **Interactivity**: Native scroll.
...
export const Gallery17Defaults: Props = {
