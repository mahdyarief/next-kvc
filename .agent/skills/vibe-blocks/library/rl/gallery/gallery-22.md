...
## Metadata
- **Category**: Gallery
- **Objective**: Lightbox Component Gallery
- **Use Case**: Detailed asset inspection.
- **Visual Style**: Grid with modal trigger.
- **Interactivity**: Modal / Fullscreen.
...
Gallery22.displayName = 'Gallery22';
```
