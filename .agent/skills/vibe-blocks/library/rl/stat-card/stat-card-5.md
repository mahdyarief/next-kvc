...
import { BiDotsHorizontalRounded, BiUpArrowAlt } from 'lucide-react';
...
export type Stat5Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Stat5 = (props: Stat5Props) => {
    ...
    <section>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 lg:grid-cols-4">
        {stats.map((stat, index) => (
          <div
            key={index}
 className="flex flex-col justify-between border border-border-primary py-6 pl-6 pr-5 md:justify-normal"
>
...
export const Stat5Defaults: Props = {
