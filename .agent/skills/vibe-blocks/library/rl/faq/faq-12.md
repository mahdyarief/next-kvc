...
## Metadata
- **Category**: FAQ
- **Objective**: Wide Split FAQ
- **Use Case**: Product detail support.
- **Visual Style**: 50/50 Split.
...
export type Faq12Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Faq12 = (props: Faq12Props) => {
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-10 gap-y-10 md:grid-cols-2 md:gap-x-8 md:gap-y-16 lg:gap-x-16">
...
export const Faq12Defaults: Props = {
  heading: "FAQs",
  description:
