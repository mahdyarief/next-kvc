...
## Metadata
- **Category**: FAQ
- **Objective**: Tabbed Category FAQ
- **Use Case**: Complex help pages.
- **Visual Style**: Tabs + Accordion.
- **Interactivity**: Tab & Accordion switches.
...
export const Faq7Defaults: Props = {
  heading: "FAQs",
  description:
