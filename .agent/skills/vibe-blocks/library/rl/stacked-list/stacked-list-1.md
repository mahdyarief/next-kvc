...
- **Objective**: Actionable User Directory
- **Use Case**: Member or account lists.
- **Visual Style**: Alternating row borders.
- **Interactivity**: Search / Sort Dropdown / Action Menus.
...
export type StackedList1Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const StackedList1 = (props: StackedList1Props) => {
  const { heading, description, sortMenu, lists, inputPlaceholder, inputIcon } = {
    ...StackedList1Defaults,
    ...props,
  };
...
export const StackedList1Defaults: Props = {
  heading: "New Users",
  description:
...
StackedList1.displayName = 'StackedList1';
```
