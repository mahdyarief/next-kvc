...
export type StackedList10Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const StackedList10 = (props: StackedList10Props) => {
  const { heading, description, sortMenu, lists, inputPlaceholder, inputIcon } = {
    ...StackedList10Defaults,
    ...props,
  };
      ...
      <div className="border-t border-border-primary">
        {lists.map((list, index) => (
          <a
            key={index}
            href={list.url}
 className="grid max-w-full grid-cols-[1fr_max-content] gap-6 border-b border-border-primary px-6 py-4"
>
...
export const StackedList10Defaults: Props = {
...
StackedList10.displayName = 'StackedList10';
```
