...
export type StackedList4Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const StackedList4 = (props: StackedList4Props) => {
  const { heading, description, buttons, options, lists } = {
    ...StackedList4Defaults,
    ...props,
  };
      ...
      <div className="border-t border-border-primary">
        {lists.map((list, index) => (
          <a
            key={index}
            href={list.url}
 className="flex max-w-full flex-col border-b border-border-primary py-4 "
>
...
export const StackedList4Defaults: Props = {
...
StackedList4.displayName = 'StackedList4';
```
