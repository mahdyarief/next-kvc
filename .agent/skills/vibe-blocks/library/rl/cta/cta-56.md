...
## Metadata
- **Category**: CTA
- **Objective**: CTA with Wide Mockup
- **Use Case**: App/Web showcase.
- **Visual Style**: Wide mockup.
...
export type Cta56Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Cta56 = (props: Cta56Props) => {
...
export const Cta56Defaults: Props = {
