...
## Metadata
- **Category**: CTA
- **Objective**: Split CTA with Large Image
- **Use Case**: Visual heavy action.
- **Visual Style**: Split layout (Wide).
...
export type Cta2Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
