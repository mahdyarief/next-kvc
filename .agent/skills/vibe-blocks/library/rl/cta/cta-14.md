...
## Metadata
- **Category**: CTA
- **Objective**: Subscription CTA
- **Use Case**: SaaS lead gen.
...
export type Cta14Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Cta14 = (props: Cta14Props) => {
...
export const Cta14Defaults: Props = {
