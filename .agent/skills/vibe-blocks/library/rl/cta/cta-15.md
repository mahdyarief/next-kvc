...
export type Cta15Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Cta15 = (props: Cta15Props) => {
...
export const Cta15Defaults: Props = {
