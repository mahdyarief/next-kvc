...
export type Product5Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Product5 = (props: Product5Props) => {
...
export const Product5Defaults: Props = {
  tagline: "Tagline",
  heading: "Products",
