...
export type Contact10Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Contact10 = (props: Contact10Props) => {
...
export const Contact10Defaults: Props = {
  image: {
...
Contact10.displayName = 'Contact10';
```
