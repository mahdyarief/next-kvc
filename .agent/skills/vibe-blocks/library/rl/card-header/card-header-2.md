...
- **Objective**: Search & Sort Card Header
- **Use Case**: Data-heavy cards requiring search and sorting capabilities.
- **Visual Style**: Heading + description with search input and sort dropdown.
- **Interactivity**: Live search input, sort criteria dropdown, dynamic filtering.
...
export type CardHeader2Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const CardHeader2 = (props: CardHeader2Props) => {
...
export const CardHeader2Defaults: Props = {
