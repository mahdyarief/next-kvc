...
## Metadata
- **Category**: Navbar
- **Objective**: Mobile Sticky Tab Nav
- **Use Case**: PWA or mobile-first apps.
- **Visual Style**: Bottom sticky bar.
- **Interactivity**: Active state transitions.
...
export const Navbar4Defaults: Props = {
  logo: {
    url: "#",
