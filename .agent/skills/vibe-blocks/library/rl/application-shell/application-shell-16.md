...
- **Objective**: High-efficiency split layout with top navigation, main content area, and right-side secondary panel optimized for productivity applications and pro-tools
- **Use Case**: Perfect for high-density content layouts, productivity applications, professional tools, and complex interfaces requiring main content with supplementary information on the right. Ideal for scenarios where users need to reference secondary information, access tool settings, or view contextual data while focusing on primary tasks. Best for pro-tools, creative applications, data analysis interfaces, and any productivity-focused software requiring optimized layout efficiency.
- **Visual Style**: Clean, optimized split layout with top navigation bar, spacious main content area, and right-side secondary panel for supplementary information. High-efficiency design with optimized spacing, clean typography, and clear visual hierarchy. The layout emphasizes productivity and workflow efficiency with minimal visual clutter, distinct background colors separating navigation and content areas, and carefully tuned proportions that maximize usable space while maintaining clear boundaries.
- **Interactivity**: Performance-tuned layout behaviors specifically optimized for pro-tools and productivity applications, smooth and efficient animations, responsive design that intelligently collapses the right panel on mobile devices, click-outside behavior for dropdowns and overlays, performance-optimized event handling, smooth transitions between states, and layout behaviors tuned for high-frequency user interactions common in professional tools

## Description
A refined, high-efficiency split-layout application shell optimized for productivity applications and pro-tools. This is a performance-tuned version specifically enhanced for high-density content layouts with a right-hand focus. Features a clean top navigation bar, spacious main content area, and a right-side secondary panel for supplementary information, contextual tools, or settings. The layout is meticulously optimized for workflow efficiency, with performance-tuned behaviors, smooth animations, and carefully calibrated spacing that maximizes usable space while maintaining clear visual hierarchy. Built for professional tools, creative applications, data analysis interfaces, and any productivity-focused software requiring high-efficiency layout optimization. The responsive design intelligently adapts the right panel for mobile devices while maintaining full functionality and performance-tuned interactions across all screen sizes.
