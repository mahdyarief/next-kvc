...
export type Portfolio9Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Portfolio9 = (props: Portfolio9Props) => {
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        <footer className="mt-6 flex justify-center md:mt-8">
...
const Project: React.FC<ProjectProps> = ({ title, description, image, url, button, tags }) => (
  <article className="mb-12 break-inside-avoid border border-border-primary">
    <div>
      <a href={url}>
...
export const Portfolio9Defaults: Props = {
  tagline: "Portfolio",
  heading: "Short heading goes here",
  description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
  projects: [project, project, projectAlt, project],
  button: {
    title: "View all",
    variant: "secondary",
    size: "primary",
...
Portfolio9.displayName = 'Portfolio9';
```
