...
export type Portfolio10Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Portfolio10 = (props: Portfolio10Props) => {
...
const Project: React.FC<ProjectProps> = ({ title, description, image, url, button, tags }) => (
  <article className="max-w-lg border border-border-primary even:ml-auto">
    <div>
      <a href={url}>
...
export const Portfolio10Defaults: Props = {
  tagline: "Portfolio",
...
Portfolio10.displayName = 'Portfolio10';
```
