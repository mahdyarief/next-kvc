...
export type Portfolio20Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
export const Portfolio20 = (props: Portfolio20Props) => {
...
>
              <div
 className={clsx("text-xl font-bold transition-colors duration-300 md:text-2xl", {
...
export const Portfolio20Defaults: Props = {
  tagline: "Tagline",
  hoverLinks: [
    {
      url: "#",
...
Portfolio20.displayName = 'Portfolio20';
```
