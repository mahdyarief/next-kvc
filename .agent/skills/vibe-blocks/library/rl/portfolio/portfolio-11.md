...
export type Portfolio11Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Portfolio11 = (props: Portfolio11Props) => {
...
Portfolio11.displayName = 'Portfolio11';
```
