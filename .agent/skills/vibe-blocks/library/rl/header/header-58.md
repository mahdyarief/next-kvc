...
## Metadata
- **Category**: Header
- **Objective**: Video BG with Stats
- **Use Case**: Immersive data display.
- **Visual Style**: Video bg + metrics.
...
export type Header58Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Header58 = (props: Header58Props) => {
  const { heading, description, tagline, inputPlaceholder, button, termsAndConditions, image } = {
    ...Header58Defaults,
    ...props,
  };
