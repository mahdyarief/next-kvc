...
## Metadata
- **Category**: Header
- **Objective**: 4-Image Grid Header
- **Use Case**: Gallery style intro.
- **Visual Style**: Four-image grid.
...
export type Header112Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Header112.displayName = 'Header112';
```
