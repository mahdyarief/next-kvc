...
## Metadata
- **Category**: Header
- **Objective**: Asymmetric Image Split
- **Use Case**: Modern editorial layout.
- **Visual Style**: Unbalanced split with images.
- **Interactivity**: Visual balance.
...
export type Header121Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
Header121.displayName = 'Header121';
```
