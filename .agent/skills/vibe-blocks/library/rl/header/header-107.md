...
## Metadata
- **Category**: Header
- **Objective**: Split with Overlap
- **Use Case**: Modern layered design.
- **Visual Style**: Overlapping text/image.
- **Interactivity**: Layered depth.
...
>
            ...
            <div className="relative top-[15%] hidden w-[40vw] sm:w-[25vw] md:block lg:w-[22vw]">
              <img className="aspect-square w-full object-cover" {...images[3]} />
            </div>
          </motion.div>
...
Header107.displayName = 'Header107';
```
