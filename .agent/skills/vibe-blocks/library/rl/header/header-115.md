...
## Metadata
- **Category**: Header
- **Objective**: Overlapping Images
- **Use Case**: Collage style hero.
- **Visual Style**: Layered image stack.
- **Interactivity**: Depth perception.
...
export type Header115Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Header115 = (props: Header115Props) => {
...
export const Header115Defaults: Props = {
...
Header115.displayName = 'Header115';
```
