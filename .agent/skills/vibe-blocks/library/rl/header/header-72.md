...
## Metadata
- **Category**: Header
- **Objective**: Scroll Scale Hero
- **Use Case**: Dynamic scroll intro.
- **Visual Style**: Scale interaction.
...
export type Header72Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
