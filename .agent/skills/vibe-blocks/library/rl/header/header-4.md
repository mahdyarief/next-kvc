...
## Metadata
- **Category**: Header
- **Objective**: Split Hero with Video Modal
- **Use Case**: Hero with video presentation.
- **Visual Style**: Split layout with video trigger.
- **Interactivity**: Modal video playback.
...
export const Header4Defaults: Props = {
