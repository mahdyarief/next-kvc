...
## Metadata
- **Category**: Header
- **Objective**: Background Image (Left Align)
- **Use Case**: Immersive hero, left text.
- **Visual Style**: Background image, left content.
...
export const Header22Defaults: Props = {
