...
## Metadata
- **Category**: Header
- **Objective**: Centered Hero (Text)
- **Use Case**: Classic centered heading.
- **Visual Style**: Single-column center.
- **Interactivity**: Centered CTAs.
