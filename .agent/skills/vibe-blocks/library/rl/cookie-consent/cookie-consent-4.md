...
- **Objective**: Compact List Cookie Preference
- **Use Case**: Minimalist privacy compliance.
- **Visual Style**: Vertical List Modal.
- **Interactivity**: Checkboxes, Compact Dialog.
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-8 flex flex-col gap-4">
              <div className="flex flex-wrap gap-4 md:flex-nowrap">
                ...
                <Button onClick={handleAcceptAll} variant="primary" className="w-full">
                  Accept all cookies
                </Button>
              </div>
...
const CookieBanner = ({
 ...
 className="absolute bottom-8 right-8 z-[998] flex w-[calc(100%-4rem)] max-w-md items-start justify-between gap-4 border border-border-primary bg-background-primary px-6 py-8 md:pl-8 md:pr-12"
>
