...
- **Objective**: Checkbox Based Cookie Banner
- **Use Case**: Privacy compliance with checkboxes.
- **Visual Style**: Full-width Banner.
- **Interactivity**: Checkboxes, Modal.
...
>
          <form onSubmit={handleSubmit}>
            ...
            <div className="h-px w-full bg-black" />
            <div className="mt-8 flex flex-col justify-end gap-4 sm:flex-row lg:items-center lg:justify-center">
...
const CookieBanner = ({
 ...
 className="absolute inset-x-0 bottom-0 z-[998] mx-auto flex max-w-xxl flex-col items-start justify-center gap-8 overflow-hidden border border-border-primary bg-background-primary px-6 py-8 lg:flex-row lg:items-center lg:pl-12 lg:pr-8"
>
          <p>
