...
## Metadata
- **Category**: Filters
- **Objective**: Horizontal Bar Filters
- **Use Case**: Modern minimalist catalog.
- **Visual Style**: Top Row Bar.
- **Interactivity**: Dropdown / Tags.
      ...
      <div className="container">
        ...
        <div className="mb-6 flex items-center justify-between">
          <Sheet>
            ...
            <SheetContent
              side="left"
 className="flex w-full flex-col p-0 md:max-w-md md:p-0 lg:max-w-md lg:p-0"
>
              <div className="relative">
                <SheetClose />
                <div className="overflow-scroll px-[5%] pt-12 lg:px-12 lg:pt-16">
                  <SheetHeader className="mb-6 text-left">
                    <SheetTitle className="text-5xl font-bold leading-[1.4]">Filters</SheetTitle>
                  </SheetHeader>
                  <div className="mt-6">
