...
## Metadata
- **Category**: Filters
- **Objective**: Modal Mobile-First Filters
- **Use Case**: Responsive app directories.
- **Visual Style**: Slide-up Modal.
- **Interactivity**: Modal apply flow.
      ...
      <div className="container">
        ...
        <div className="mb-6 flex items-center justify-between">
          <Sheet>
            ...
            <SheetContent
              side="bottom"
 className="h-screen w-full p-0 md:p-0 lg:max-h-[80vh] lg:max-w-[40rem] lg:p-0"
>
              <div className="overflow-scroll px-[5%] pt-2 lg:px-12">
                ...
                <div className="-mx-[5%] border-b border-border-primary pt-4 lg:-mx-12" />
                <div className="mt-6">
                  <FilterSections key={key} onClearAll={handleClearAll} />
                </div>
              </div>
              <SheetFooter className="sticky bottom-0 border-t border-border-primary bg-neutral-white px-[5%] py-2 md:py-3 lg:px-12 lg:py-3">
