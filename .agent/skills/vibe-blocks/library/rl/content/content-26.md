...
export type Content26Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Content26 = (props: Content26Props) => {
...
export const Content26Defaults: Props = {
...
Content26.displayName = 'Content26';
```
