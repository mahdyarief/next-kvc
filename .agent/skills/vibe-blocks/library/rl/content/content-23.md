...
export type Content23Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Content23 = (props: Content23Props) => {
...
export const Content23Defaults: Props = {
...
Content23.displayName = 'Content23';
```
