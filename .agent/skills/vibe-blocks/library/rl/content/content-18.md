...
export type Content18Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Content18 = (props: Content18Props) => {
...
export const Content18Defaults: Props = {
...
Content18.displayName = 'Content18';
```
