...
## Metadata
- **Category**: Table
- **Objective**: Comprehensive Data Grid
- **Use Case**: User logs, order history, inventory.
- **Visual Style**: Bordered table with header actions.
- **Interactivity**: Pagination / Row-specific view links.
