...
## Metadata
- **Category**: Table
- **Objective**: Minimal Striped Table
- **Use Case**: High-density information.
- **Visual Style**: Alternating row backgrounds.
...
export type Table3Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Table3 = (props: Table3Props) => {
...
export const Table3Defaults: Table3Props = {
