...
export type Form11Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Form11 = (props: Form11Props) => {
 ...
 className="pr-10"
          ...
          <div className="grid w-full max-w-md grid-cols-1 gap-6 md:grid-cols-2 md:gap-4">
            ...
            <div className="grid max-w-md items-center">
...
export const Form11Defaults: Props = {
