...
export type Form9Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Form9 = (props: Form9Props) => {
...
export const Form9Defaults: Props = {
