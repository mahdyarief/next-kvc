...
export type Form20Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Form20 = (props: Form20Props) => {
 ...
 className="grid auto-cols-fr grid-cols-1 gap-6 border border-border-primary p-8"
>
...
export const Form20Defaults: Props = {
