...
export type Form13Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Form13 = (props: Form13Props) => {
...
export const Form13Defaults: Props = {
