...
export type Form17Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Form17 = (props: Form17Props) => {
...
export const Form17Defaults: Props = {
