...
export type Form12Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Form12 = (props: Form12Props) => {
...
export const Form12Defaults: Props = {
