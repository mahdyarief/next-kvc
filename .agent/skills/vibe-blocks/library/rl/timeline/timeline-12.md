...
export type Timeline12Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Timeline12 = (props: Timeline12Props) => {
...
export const Timeline12Defaults: Props = {
  tagline: "Tagline",
...
Timeline12.displayName = 'Timeline12';
```
