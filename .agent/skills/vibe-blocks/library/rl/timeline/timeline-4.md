...
## Metadata
- **Category**: Timeline
- **Objective**: Compact History Stack
- **Use Case**: Resume or short-term event flow.
- **Visual Style**: Thin vertical indicator.
- **Interactivity**: Static / Link actions.
...
export const Timeline4Defaults: Props = {
  tagline: "Tagline",
...
Timeline4.displayName = 'Timeline4';
```
