...
## Metadata
- **Category**: Timeline
- **Objective**: Horizontal Progression
- **Use Case**: Project phases or product roadmap.
- **Visual Style**: Scrollable horizontal line.
- **Interactivity**: Native scroll / Hover states.
...
export const Timeline3Defaults: Props = {
  tagline: "Tagline",
...
Timeline3.displayName = 'Timeline3';
```
