...
export type Timeline8Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Timeline8 = (props: Timeline8Props) => {
...
export const Timeline8Defaults: Props = {
  tagline: "Tagline",
...
Timeline8.displayName = 'Timeline8';
```
