...
export type Testimonial25Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Testimonial25 = (props: Testimonial25Props) => {
  const { heading, description, testimonials } = {
    ...Testimonial25Defaults,
    ...props,
  };
  return (
...
export const Testimonial25Defaults: Props = {
  heading: "Customer testimonials",
  description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
  testimonials: [testimonial, testimonial],
};

Testimonial25.displayName = 'Testimonial25';
```
