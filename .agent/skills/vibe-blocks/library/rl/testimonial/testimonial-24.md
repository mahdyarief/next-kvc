...
export type Testimonial24Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Testimonial24 = (props: Testimonial24Props) => {
  const { heading, description, testimonials } = {
    ...Testimonial24Defaults,
    ...props,
  };
...
export const Testimonial24Defaults: Props = {
...
Testimonial24.displayName = 'Testimonial24';
```
