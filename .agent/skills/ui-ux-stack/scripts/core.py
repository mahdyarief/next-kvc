...
CSV_CONFIG = {
    ...
    "color": {
        ...
        "output_cols": ["Product Type", "Keywords", "Primary", "Secondary", "Accent", "Background", "Foreground", "Muted", "Notes"]
    },
    "chart": {
        "file": "charts.csv",
...
STACK_CONFIG = {
    ...
    "payload": {"file": "stacks/payload.csv"}
}
...
def detect_domain(query):
    ...
    domain_keywords = {
        "color": ["color", "palette", "hex", "#", "rgb", "semantic", "token", "variable"],
