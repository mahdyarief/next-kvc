...
const REPO_OWNER = "kelasvibecoding";
const REPO_NAME = "NEXT-KVC";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const io = (globalThis as unknown as Record<string, unknown>).io as undefined | { to: (room: string) => { emit: (event: string, data: unknown) => void } };
    if (io) {
